...
const CATS = {
  ...
  GEOM:     { label:'Geometry',         color:C.blue,   bg:C.blueDim,   icon:'' },
  GEOMADV:  { label:'Advanced Geometry',color:C.blue,   bg:C.blueDim,   icon:'' },
  FASTEN:   { label:'Track Fastening',  color:C.green,  bg:C.greenDim,  icon:'' },
  ADV:      { label:'Switch & Turnout', color:C.violet, bg:C.violetDim, icon:'' },
  NDT:      { label:'Inspection & NDT', color:C.cyan,   bg:C.cyanDim,   icon:'' },
  RAILCUT:  { label:'Rail Cutting & Drilling', color:C.orange, bg:C.orangeDim, icon:'' },
  RAILWEAR: { label:'Rail Wear & Profile', color:C.teal, bg:C.tealDim, icon:'' },
  CONSUM:   { label:'Consumables',      color:C.slate,  bg:C.slateDim,  icon:'' },
  SIGNAL:   { label:'Track Circuit',    color:C.blue,   bg:C.blueDim,   icon:'' },
...
const RAW_BY_SUBSYSTEM = {
  ...
  ['t07','T','LOTO','Personal LOTO kit - trackside specific - spring-loaded padlock + tags + insulated hasp','Brady','Brady 65674 Personal LOTO Kit','Trackside maintenance','-','OB',1,58,'10 years','Individual isolation of track circuit equipment, point motors and heating systems before maintenance. Each technician applies their own padlock.','https://www.bradyid.eu/en-eu/lockout-tagout/personal-lockout-kits/65674'],
  ...
  ['t10','T','GEOM','Digital rail thermometer - adhesive magnetic contact - web attachment - range -40 C to +80 C','Goldschmidt / PIE','Goldschmidt RAIL THERMOMETER / PIE PRT-01','Plain track inspection','-','OB',1,185,'7 years','Rail temperature measurement before welding, re-stressing or CWR adjustment. Magnetic web-contact gives a reliable bulk rail temperature for records and decision-making.','https://www.gt-railservice.com/en/portfolio/measurement/measurement-devices/'],
  ['t11','T','GEOM','Steel tape measure 30 m - stainless - magnetic end - track geometry reference','Stanley / Lufkin','Stanley FatMax FMHT36326 30m / Lufkin stainless 30m','Plain track inspection','-','OB',1,55,'5 years','Measurement of sleeper spacing, track joint gaps, fishplate bolt spacing and chord lengths for versine measurement.','https://uk.rs-online.com/web/c/tools/hand-tools/measuring-tapes/'],
  ['t12','T','FASTEN','Manual rail clip insertion/extraction lever - Pandrol E-clip / FASTCLIP system','Geismar / Pouget Rail','Geismar Pandrol FASTCLIP lever / Pouget Rail lever PANDROL','Track fastening','-','OB',1,85,'5 years','Manual insertion and extraction of elastic rail clips for corrective maintenance without machine support.','https://www.pougetrail.com/en/products-page/outillage-a-main/leviers-fastclip/'],
  ['t13','T','FASTEN','Fishplate bolt spanner T-bar - railway specific - Pouget Rail / Geismar type','Pouget Rail / Geismar','Pouget Rail Clé à main en T / Geismar T-wrench','Track fastening','-','OB',1,45,'7 years','Manual T-bar wrench for fishplate bolts on jointed track and at turnout rail connections.','https://www.pougetrail.com/en/products-page/outillage-a-main/cles-a-main-en-t/'],
  ['t14','T','ADV','Feeler gauge set 10-leaf 0.05-0.80 mm - tongue/stock rail contact check','Facom / Mitutoyo','Facom 806.5M / Mitutoyo 188-110 feeler gauge set','Switch and turnout inspection','-','OB',1,28,'5 years','Critical check of tongue rail contact with stock rail and other small switch clearances.','https://www.facom.com/en-gb/products/'],
  ['t15','T','NDT','Weld gap gauge (calibre de jeu) - 1-25 mm graduated - aluminothermic weld prep','Goldschmidt / Geismar','Goldschmidt weld gap gauge / Geismar gap gauge','Weld preparation and inspection','-','OB',1,35,'5 years','Verification of rail gap width before aluminothermic welding and rail-joint expansion checks.','https://www.gt-railservice.com/en/products/railway-products/thermite-welding/'],
  ['e01','E','LEVAGE','Chain hoist 3t - short-travel - rail and ADV panel handling','Yale','Yalelift 360 3t hand chain hoist','Track and turnout handling','-','RC',1,485,'10 years','Shared manual chain hoist for short-lift rail and turnout panel handling, insulated-joint support, component positioning and controlled lifting tasks where a compact 3t hand hoist is sufficient.','https://www.cmco.com/globalassets/catalogs--documents/emea/en/chapters-no5/02_cmco_no5_2024_04_wup_en-hoisting-equipment.pdf'],
  ...
  ['e03','E','RAILCUT','Portable rail drill - battery or pneumatic - rail web drilling for fishplate bolts','Geismar / Robel','Geismar PLB2 / Robel 11.50 pneumatic drill','Track intervention and renewal','-','OB',1,1450,'7 years','Drilling rail web bolt holes for fishplates, insulated joints and intermediate joints during CWR maintenance.','https://geismar.com/product_categories/perçage-sciage/perçage/'],
  ['e04','E','COLLECTIF','Rugged Laptop Toughbook 55 Series','Panasonic','TOUGHBOOK 55 mk3','Shared team support','-','RC',1,2595,'5 years','Shared diagnostic laptop for track geometry software, maintenance reporting and rugged field use in possession conditions.','https://eu.connect.panasonic.com/de/en/products/toughbook/toughbook-55-series'],
  ...
  ['e07','E','COLLECTIF','Scaffold/access safety board set - ballast planks + sleeper protection pads','Railtech / specialist','Track ballast boarding set / Railtech access boards','Shared team support','-','RC',1,285,'5 years','Trackside working platform on ballast with pads to protect sleepers during intensive maintenance.','https://uk.rs-online.com/web/c/safety-security/'],
  ['e08','E','GEOM','Digital track gauge with electronic cant (superelevation) - +/-1mm - Bluetooth - EN 13848','Goldschmidt','Trackgauge Digital (TGD)','Track geometry control','EN 13848','OB',1,1850,'10 years','Digital track and switch geometry gauge for gauge, cant and related checks with app-based recording and reporting.','https://www.goldschmidt.com/en/product/trackgauge-digital/'],
  ['e09','E','FASTEN','Portable battery-powered screwing machine - tirefonds + clip fasteners - Geismar Mantis','Geismar','Geismar Mantis Activion battery screwing machine','Track fastening and bolting','-','OB',1,3800,'7 years','Battery-powered screwing machine for tirefonds and fishplate bolts during routine and corrective track work.','https://geismar.com/produits/cle-a-chocs-sur-batterie-mantis/'],
  ['e10','E','GEOM','Versine chord (20 m or 10 m) - string line + offset gauge for alignment checks','Pouget Rail / Geismar','Pouget Rail / Geismar Chord System','Track geometry control','-','OB',1,95,'10 years','Horizontal and vertical alignment checks on track using 10 m or 20 m chord methods.','https://geismar.com/'],
  ['e11','E','RAILWEAR','Rail head wear gauge - vertical + lateral wear - mechanical template type - 60E1/UIC60 - plain track','Robel / Geismar','Robel 14.63 / Geismar JD-1 head wear gauge','Rail and profile inspection','-','OB',1,185,'10 years','Measurement of vertical and lateral rail head wear on plain track to relevant rejection limits.','https://www.robel.com/en/products-applications/'],
  ['e12','E','RAILWEAR','Digital rail profile calliper - web thickness + head width + foot width - 1 mm resolution','PIE / Robel','PIE RC-1D Rail Sliding Calliper / Robel rail calliper','Rail and profile inspection','-','OB',1,145,'10 years','Cross-section measurement of worn rail sections before replacement or acceptance.','https://paragoninstruments.com/railway-measurement/track-measurement/'],
  ['e13','E','RAILWEAR','Taper gauge - aluminium anodised - 1 mm to 25 mm graduated - flangeway clearance','Backtrack / PIE','Backtrack Taper Gauge / PIE tapered gauge','Rail and profile inspection','-','OB',1,35,'7 years','Measurement of flangeway clearances at checkrails, guardrails and frog throats.','https://backtrack.com/en-us/collections/measuring-and-gauging'],
  ['e14','E','RAILWEAR','Straightedge 1 m + feeler gauge set - rail surface evenness - post-weld QC','Goldschmidt / Robel','Goldschmidt RAILSTRAIGHT COMPACT / Robel straightedge 1m','Rail and profile inspection','-','OB',1,185,'10 years','Post-weld running-surface evenness check before line reopening or acceptance.','https://www.gt-railservice.com/en/portfolio/measurement/measurement-devices/'],
  ['e15','E','FASTEN','Torque wrench 1/2" 40-200 Nm COFRAC - medium-range rail hardware','Facom','Facom S.307A200','Track fastening and bolting','-','OB',1,389,'10 years','Controlled tightening of medium-range rail and turnout hardware where traceable torque is required.','https://www.facom.com/product/s307a200/12-digi-cal-mechanical-torque-wrench-removable-ratchet-attachment-14-x-18-range-40-200nm'],
  ['e16','E','FASTEN','Impact socket set for track fasteners - 1" square drive - Stumec/Geismar profile 23 mm','Airtec / Stumec','Airtec 23mm impact socket set / Stumec railway sockets','Track fastening and bolting','-','OB',1,145,'5 years','Impact sockets for tirefonneuse and battery screwing machines on standard railway fasteners.','https://airtecinternational.co.uk/railway-maintenance-tools/'],
  ['e17','E','ADV','Turnout gauge (règle ADV) - mechanical - ecartement + contre-rail + jeu + écartement aiguille','Pouget Rail / Robel','Pouget Rail SW-9182 / Robel turnout gauge','Switch and turnout maintenance','-','OB',1,380,'10 years','Universal turnout inspection gauge covering gauge, check rail, switch opening and flangeway clearances.','https://www.pougetrail.com/en/products-page/mesures-et-controles/regles-de-controle-des-appareils-de-voie/'],
  ['e18','E','ADV','Switch tongue wear gauge - vertical + lateral wear of tongue and frog - template type','PIE / Robel','PIE PSWG-1 digital / Robel tongue wear gauge','Switch and turnout maintenance','-','OB',1,165,'10 years','Measurement of tongue rail and frog wear during turnout inspection campaigns.','https://paragoninstruments.com/railway-measurement/track-measurement/'],
  ['e19','E','ADV','Frog/crossing wear gauge - manganese frog - vertical wear and flangeway geometry','Goldschmidt / PIE','Goldschmidt RAILPROFILE X-Y / PIE frog profile gauge','Switch and turnout maintenance','-','OB',1,285,'10 years','Profile measurement of manganese steel frog wear and flangeway geometry.','https://www.gt-railservice.com/en/portfolio/measurement/measurement-devices/'],
  ['e20','E','ADV','Switch opening verification gauge - tongue tip clearance - 31 to 60 mm range','Pouget Rail','Pouget Rail K-120 accessory / standard switch opening tool','Switch and turnout maintenance','-','OB',1,55,'10 years','Quick go/no-go verification that the tongue tip is sufficiently clear of the stock rail in open position.','https://www.pougetrail.com/en/products-page/mesures-et-controles/'],
  ['e21','E','ADV','Adjustment bar (barre de maintien écartement) - insulated - spring-loaded - 1435 mm','Pouget Rail / Geismar','Pouget Rail ref 111 (insulated) / Geismar écarteur','Switch and turnout maintenance','-','OB',2,185,'10 years','Maintain correct track gauge during switch maintenance, clip replacement and rail realignment in track-circuit areas.','https://www.pougetrail.com/en/products-page/outillage-a-main/barres-maintien-ecartement/'],
  ['e22','E','ADV','Switch lock key (clé d’aiguillage) + extension handle','Industry-Railway / Geismar','Industry-Railway Suppliers switch key / Geismar switch key','Switch and turnout maintenance','-','OB',2,45,'10 years','Manual operation and locking of switch points during maintenance possessions.','https://industryrailway.com/products/railroad-track-tools'],
  ['e23','E','RAILCUT','18V Angle Grinder 125 mm','Bosch Professional','GWS 18V-15 SC Professional','Track intervention and renewal','-','RC',1,195,'7 years','Shared cordless grinder for seized fasteners, rust removal, rail accessory preparation, weld prep and general deburring.','https://www.bosch-professional.com/gb/en/products/gws-18v-15-sc-06019H6100'],
  ...
  ['e27','E','NDT','Dye penetrant (PT) inspection kit - rails and welds - EN ISO 3452','Magnaflux / Ardrox','Magnaflux Spotcheck SKL-SP2 kit / Ardrox 9PR penetrant','Rail and weld inspection','EN ISO 3452','RC',1,95,'N/A','Surface crack detection on rail welds, switch tongue tips, frog noses and other stress-concentration zones.','https://www.magnaflux.com/Magnaflux/Products/'],
  ['e28','E','CONSUM','Rail switch lubricant applicator - automatic grease dispenser - tongue slide plates','Elwema / Geismar','Elwema EASYGREASE / Geismar switch lubricator','Track maintenance consumables','-','RC',1,185,'5 years','Lubrication of switch slide plates and tongue rail base during routine turnout maintenance.','https://geismar.com/'],
  ['e29','E','CONSUM','Rail anti-corrosion and gauge face lubricant - spray + brush applicator - 3 L can','Interflon / Vossloh','Interflon Fin Super / Rail-Pro gauge face lube','Track maintenance consumables','-','RC',2,45,'N/A','Gauge face lubrication on curves and anti-corrosion treatment of joints, fishplates and exposed fastener heads.','https://uk.rs-online.com/web/c/adhesives-sealants-maintenance-chemicals/lubricants/'],
  ...
  ['e31','E','CONSUM','Rail marking paint + paint sticks - defect/maintenance marking - trackside use','Krylon / Soppec','Krylon Ultra-Flat railway marking paint / Soppec track paint','Track maintenance consumables','-','RC',1,28,'N/A','Trackside marking of defects, measurement reference points, weld locations and inspection records.','https://uk.rs-online.com/web/c/adhesives-sealants-maintenance-chemicals/'],
  ['e32','E','SIGNAL','Insulation tester for insulated joints and track circuit isolation','Chauvin Arnoux','P01140826 CA 6526','Track circuit and bonding','-','RC',1,785,'8 years','Insulation tester for insulated joints, rail-to-rail isolation checks and track-circuit insulation verification.','https://www.datatec.eu/de/en/chauvin-arnoux-p01140826'],
  ['e33','E','SIGNAL','Low-resistance bond continuity tester / micro-ohmmeter for rail bonds','Megger','DLRO10X','Track circuit and bonding','-','RC',1,4615,'8 years','Low-resistance micro-ohmmeter for rail-bond continuity, impedance bonds and traction return connection integrity.','https://www.euro-index.nl/en/product/megger-dlro10x/'],
  ['e34','P','GEOMADV','Push-along track geometry measurement trolley - ecartement + devers + versines + twist - EN 13848','Pandrol','GeoVizio-TR-Smart','Project geometry and renewal','EN 13848','RC',1,18500,'10 years','Push-along smart track geometry trolley for gauge, cant, twist, longitudinal level and alignment measurement with software-assisted recording and project analysis.','https://www.pandrol.com/wp-content/uploads/2023/03/GeoVizio-TR-Smart-EN.pdf'],
  ['e35','P','GEOMADV','Pandrol VERSE system - stress-free temperature (TNA) measurement - CWR non-destructive','Pandrol','VERSE stress-free temperature system','Project geometry and renewal','-','RC',1,12500,'10 years','Non-destructive stress-free temperature measurement system for CWR management and rail neutral temperature verification.','https://www.pandrol.com/wp-content/uploads/2018/10/Verse-DE.pdf'],
  ['e36','P','NDT','Sonatest Railscan 125+ portable UT flaw detector + walking stick probe system','Sonatest','Railscan 125+ with walking stick probe','Specialist rail inspection','-','RC',1,8500,'10 years','Portable ultrasonic rail flaw detector with walking-stick probe system for project-level internal rail defect detection and weld inspection.','https://sonatest.com/download_file/force/8fe0d373-1fff-4934-bdd0-dae67bed13ec/382'],
  ['e37','P','NDT','Eddy current surface inspection system - portable - RCF / head checking detection','Eddyfi Technologies','Amigo2 portable surface-crack inspection system','Specialist rail inspection','-','RC',1,12500,'10 years','Portable project-level surface inspection platform for specialist crack detection campaigns on rail head and high-stress components.','https://www.eddyfi.com/en/product/amigo-2'],
  ['e38','P','LEVAGE','Hydraulic rail stressor (vérin de traction rail) - CWR re-stressing - 1000 kN','Enerpac','RP70A modular rail stressor','CWR stressing and heavy lifting','-','RC',1,8500,'10 years','Modular rail stressor for project-level CWR re-stressing, weld repair preparation and neutral-temperature correction work.','https://vault.enerpac.com/m/191921813cef6719/original/9932_Rail-Stressors_Essential-Guide_EN-GB_A4.pdf?download='],
  ['e39','P','LEVAGE','Portable hydraulic jack set - 20t - with pump - track panel lifting','Enerpac','P-392 + RC201 cylinder set','CWR stressing and heavy lifting','-','RC',1,2800,'10 years','Lifting of track panels, turnout components and pre-assembled ADV elements during renewal operations.','https://www.enerpac.com/en-us/p392-two-speed-hand-pump/p392'],
  ['e40','P','RAILCUT','Portable battery rail cutter - cold saw type - 60E1 / UIC54 to UIC60 - no heat','Geismar','Shark Activion battery rail saw','Project rail intervention','-','RC',1,2200,'7 years','Portable battery rail saw for cold cutting of rail profiles during project intervention and controlled renewal work.','https://geismar.com/wp-content/uploads/2023/09/Geismar_Leaflet_Shark_Activion_EN.pdf'],
...
const TOOL_CONTEXT_OVERRIDES = {
  ...contextOverridesFor([
    ...
    'TRACK:t11','TRACK:t12','TRACK:t13','TRACK:t14','TRACK:t15',
    'TRACK:e01','TRACK:e02','TRACK:e03','TRACK:e04','TRACK:e05','TRACK:e06','TRACK:e07','TRACK:e08','TRACK:e09','TRACK:e10',
    'TRACK:e11','TRACK:e12','TRACK:e13','TRACK:e14','TRACK:e15','TRACK:e16','TRACK:e17','TRACK:e18','TRACK:e19','TRACK:e20',
    'TRACK:e21','TRACK:e22','TRACK:e23','TRACK:e24','TRACK:e25','TRACK:e26','TRACK:e27','TRACK:e28','TRACK:e29','TRACK:e30',
    'TRACK:e31','TRACK:e32','TRACK:e33','TRACK:e34','TRACK:e35','TRACK:e36','TRACK:e37','TRACK:e38','TRACK:e39','TRACK:e40','TRACK:e41',
  ], ['metro', 'tram', 'heavy']),
  ...contextOverridesFor([
...
export const TOOLING_LIFECYCLE_DEFAULTS = {
  ...
  ...lifecycleDefaultsFor(['TRACK:t11', 'TRACK:t12', 'TRACK:t14', 'TRACK:t15', 'TRACK:e04', 'TRACK:e07', 'TRACK:e16', 'TRACK:e28'], {
    type: 'periodic_replacement',
    intervalValue: '60',
    intervalUnit: 'months',
    replacementRatio: '100',
  ...
  ...lifecycleDefaultsFor(['TRACK:t10', 'TRACK:t13', 'TRACK:e03', 'TRACK:e05', 'TRACK:e06', 'TRACK:e09', 'TRACK:e13', 'TRACK:e23', 'TRACK:e40'], {
    type: 'periodic_replacement',
    intervalValue: '84',
    intervalUnit: 'months',
    replacementRatio: '100',
  ...
  ...lifecycleDefaultsFor(['TRACK:t07', 'TRACK:e01', 'TRACK:e02', 'TRACK:e08', 'TRACK:e10', 'TRACK:e11', 'TRACK:e12', 'TRACK:e14', 'TRACK:e15', 'TRACK:e17', 'TRACK:e18', 'TRACK:e19', 'TRACK:e20', 'TRACK:e21', 'TRACK:e22', 'TRACK:e24', 'TRACK:e25', 'TRACK:e26', 'TRACK:e34', 'TRACK:e35', 'TRACK:e36', 'TRACK:e37', 'TRACK:e38', 'TRACK:e39', 'TRACK:e41'], {
    type: 'periodic_replacement',
    intervalValue: '120',
    intervalUnit: 'months',
    replacementRatio: '100',
...
export const TOOLING_SERVICE_DEFAULTS = {
  ...
  ...serviceDefaultsFor(['TRACK:e39'], {
    type: 'inspection',
    cost: '185',
    source: 'Track workbook baseline - pressure and lifting inspection',
    year: '2026',
    basis: 'estimated',
  }),
};
...
const TOOL_IMAGE_OVERRIDES = {
  ...
  'TRACK:t07': 't06_brady_65674_personal_loto_kit.jpg',
  'TRACK:t09': 't09_portwest_kp20.jpg',
  'TRACK:e02': 'e27_fluke_376_fc_iflex_kit.webp',
  'TRACK:e04': 'e48_panasonic_toughbook_55_mk3.jpg',
