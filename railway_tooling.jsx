...
const CATS = {
  ...
  CONSUM:   { label:'Consumables',      color:C.slate,  bg:C.slateDim,  icon:'' },
...
const RAW_BY_SUBSYSTEM = {
  ...
  ['t02','E','SAFETY','Non-contact AC Voltage Detector 100-1000V','Fluke','T6-1000PRO','LV','CAT IV 1000V','OB',1,378,'Annual','Shared team electrical tester for fast energized/not-energized screening before deeper verification with the formal VAT. Kept at team level rather than personal issue.','https://www.fluke.com/fr-fr/produit/testeurs-electriques/testeurs-tension/fluke-t6-1000-pro'],
  ...
  ['t11','E','SAFETY','VDE Torque Wrench 1/2" 10-50 Nm','Gedore','VDE 4508-05','LV','DIN EN ISO 6789-2 / IEC 60900','RC',1,395,'Annual (calibration)','Shared insulated torque wrench for controlled tightening on protected LV components up to 1000 V. Kept at team level because this is not a daily personal-carry item.','https://www.gedore.com/en-at/products/torque-tools/torque-wrenches--accessories/torque-wrenches%2C-releasing-for-sockets/vde-4508-vde-torque-wrench/vde-4508-05---3079066'],
  ['t12','E','MBTDC','Portable Insulation Tester 500V/1000V','Fluke','1507 Insulation Tester','DC Auxiliaries 24-110V / LV','IEC 61557-2 - CAT IV 600V','OB',1,699,'Annual (calibration)','Shared team insulation tester for auxiliary circuits, LV cabling and motor/control-circuit insulation checks. Positioned at team level rather than as a personal daily asset.','https://www.fluke.com/fr-fr/produit/testeurs-isolement/fluke-1507'],
  ['t15','E','MBTDC','TRMS AC/DC Clamp Meter 1000A with iFlex','Fluke','376 FC','LV / DC Traction 750-1500V','CAT IV 600V - CAT III 1000V','OB',1,703,'Annual (calibration)','Shared team clamp meter with iFlex for current checks on LV feeders, auxiliaries and traction-related conductors when a standard multimeter is not practical.','https://www.fluke.com/fr-fr/produit/mesure-courant/pinces-amperemetriques/fluke-376-fc'],
  ['t17','E','MBTDC','Traction DC Bipolar Voltage and Polarity Tester 24-1500V','Gossen Metrawatt','METRAVOLT 12D+L','DC Traction 750-1500V / LV','DIN EN 61243-3 - CAT IV 600V / CAT III 1000V','RC',1,435,'Annual','Shared team two-pole contact tester for traction DC polarity identification, AC/DC voltage confirmation and diagnostic checks where the safety VAT alone is not sufficient.','https://www.gossenmetrawatt.de/produkte/mess-und-prueftechnik/prueftechnik/pruefung-elektrischer-installationen-und-anlagen/spannung-phase-drehfeld-durchgang-polaritaet/metravolt-12d-plusl/'],
  ...
  ['t28','E','OUTILS','Team Drill/Driver 18V for routine fastening','Bosch','GSR 18V-55 Professional','All domains - routine fixing and assembly','-','OB',1,317,'Replace if defective','Shared team cordless drill/driver for cabinet covers, terminal blocks, light brackets, trunking accessories and routine assembly work. Kept as a common team platform rather than personal issue.','https://www.bosch-professional.com/fr/fr/products/gsr-18v-55-06019H5200'],
  ...
  ['e20','P','MHTA','Digital Insulation Resistance Meter 10kV DC','Megger','MIT1025/2','MV 10-36kV / HV 25kV','IEC 61557-2','RC',1,4422,'Annual (calibration)','Project-level insulation tester for MV cables and 25kV transformer windings. Kept above team level due to cost, calibration burden and specialist use.','https://www.megger.com/fr/products/test-equipment/insulation-resistance-testers/mit1025'],
  ...
  ['t05','T','PPE','Safety Harness EN 361 full-body','3M DBI-SALA','ExoFit XE50','OLE - overhead contact line maintenance','EN 361','OB',1,306.43,'Annual (inspection by competent person)','Standardised full-body fall-arrest harness for catenary work at height on aerial work platforms and fixed structures. Lanyard or SRL selection remains separate and must be adapted to the access method and risk assessment. Replace after any fall or shock loading.','https://www.3m.com/3M/en_US/p/d/b5005059006/'],
  ...
  ['e11','E','SAFETY','Portable earthing + short-circuit set 25kV / 1500V DC - catenary clamp + rail clamp + copper braid','Stanley Dubuis','TPU + MPR earthing set','OLE - overhead contact line maintenance','-','OB',1,650,'Annual (visual + resistance test)','Critical safety equipment used after the voltage detector confirms de-energisation. Shorts and earths the catenary wire to the running rail. Includes the rail-foot clamp MPR, the catenary clamp and the copper braid. Current price remains an internal estimate pending supplier quote for the exact network-rated configuration.','https://industrialtoolsandattachments.com/products/catenary-maintenance'],
  ...
  ['e13','E','OUTILS','Contact wire self-locking clamp pliers - autolock - contact wire groove fit','Supplier quote / TBD','Reference to be confirmed','OLE - overhead contact line maintenance','-','OB',2,95,'Annual (visual)','Holding and repositioning contact wire during clamp replacement, dropper fitting, and kink repair without releasing wire tension. Auto-locking jaw grips grooved copper wire securely. Quantity assumes clamping on both sides of the work zone. Reference kept intentionally open pending supplier confirmation of a current market model.','https://galland-sas.com/wp-content/uploads/2024/08/GALLAND-CATALOGUE-OUTILLAGE-2020.pdf'],
  ...
  ['e24','E','OUTILS','Engineering hand file set 5 pcs - flat / half-round / round / square / second cut','Bahco','1-478-08-1-2 ERGO Engineering File Set','OLE - overhead contact line maintenance','-','OB',1,37,'10 years','Shared general-tooling file set for deburring, edge dressing, local fitting correction and light manual finishing on brackets, supports, clamps and small OLE mechanical parts during team maintenance work.','https://www.bahco.com/int_en/ergotm-engineering-file-set-4-bastard-1-second-cut-200-mm---5-pcs-1-478-08-1-2.html'],
  ['e25','E','CONSUM','Galvanized mast touch-up kit - zinc-rich cold galvanizing spray + local prep consumables','ZINGA','Zingaspray 500 ml','OLE - overhead contact line maintenance','N/A (consumable)','RC',1,24,'N/A','Shared team consumable for local touch-up of scratched or locally abraded galvanised mast parts, brackets and steel supports after minor OLE interventions. Intended for small prepared areas only, with manual cleaning and degreasing before application; not a substitute for structural corrosion repair or full coating renewal.','https://zinga.eu/docs/datasheets/TDS-Zingaspray-ENG-v4.pdf'],
  ],
  PSD: [
  ...
  ['t17','T','CONSUM','Dry PTFE Lubricant Spray 400 ml','WD-40','Specialist PTFE Lubricant 300013','Guides, latches and moving parts','-','OB',2,12,'Consumable','Dry PTFE lubricant for guides, latch pins, rolling mechanisms and friction points where dust retention must be limited.','https://uk.rs-online.com/web/p/lubricants/0382306/'],
  ['t18','T','CONSUM','Silicone Spray 500 ml','Wurth','0893 221','Seals and gaskets','-','OB',1,9,'Consumable','Seal conditioner and lubricant for rubber seals, gaskets and flexible wipers.','https://eshop.wurth.co.uk/Product-categories/Silicon-spray/31083007150102.cyid/3108.cgid/en/GB/GBP/'],
  ['t19','T','CONSUM','Microfibre Cloths + Glass Cleaner Kit','Wurth','Professional Glass Cleaner + cloths','Glass panels and optical sensors','-','OB',2,14,'Consumable','Cleaning kit for glass panels, optical sensors and emitter lenses to prevent false obstruction faults.','https://www.wurth.co.uk/glass-cleaner'],
  ...
  TRACK: [
  ['t01','T','PPE','Hi-visibility Winter Bomber Jacket Class 3','Portwest','C465','Trackside maintenance','-','OB',1,69,'2 years','Cold-weather high-visibility outer layer for trackside interventions, night access, possession work and exposed outdoor sections where weather protection and Class 3 visibility are both required.','https://www.lyreco.com/webshop/FRLU/veste-bomber-hi-vis-portwest-c465-orange-bleu-marine-taille-m-la-piece-product-000000000007875167.html'],
  ['t02','T','PPE','Safety Shoes S3 ESD SRC mid-cut','PUMA Safety','KRYPTON MID 634200','Trackside maintenance','EN ISO 20345 - S3 ESD SRC','OB',1,119.39,'2 years','Standardised mid-cut safety footwear for daily trackside walking, ballast access, switch inspection and general rail maintenance where grip, toe protection and durable all-shift comfort are needed.','https://www.puma-safety.com/eu/de/maenner/schuhe/sicherheitsschuhe/sicherheitsschuhe-s3/231/krypton-mid-puma-safety-sicherheitsschuhe-s3-esd'],
  ['t03','T','PPE','Safety helmet EN 397 - Class E dielectric - with chin strap','JSP Safety','JSP EVO3 REV AJF170','Trackside maintenance','EN 397 - Class E','OB',1,55,'3 years','Head protection for track maintenance: falling rail components, ballast projection during compaction, low bridges, overhead structure clearances. Dielectric class for proximity to track circuits and signalling equipment.','https://www.jspsafety.com/en-gb/products/head-protection/helmets/evo3-revolution/'],
  ...
  ['t11','T','OUTILS','Open-reel long tape measure 30 m - track geometry reference','Stanley','FatMax 0-34-132 30 m','Plain track inspection','-','OB',1,55,'5 years','Open-reel long tape used for sleeper spacing, track joint gaps, fishplate bolt spacing and chord lengths for versine measurement during routine track inspection and setting-out work.','https://www.rapidonline.com/stanley-0-34-132-fatmax-long-tape-30m-100ft-width-9-5mm-84-6961'],
  ...
  ['e02','E','MBTDC','Fluke 376 FC TRMS clamp meter 1000A - traction return current on rail','Fluke','Fluke 376 FC (art.4543454)','Track circuit and bonding','CAT IV 600V - CAT III 1000V','RC',1,703,'10 years','Measurement of traction return current distribution in rails and continuity checks after CWR repair.','https://www.fluke.com/en/product/electrical-testing/clamp-meters/fluke-376-fc'],
  ['e03','P','OUTILS','Portable rail drill - project rail web drilling for fishplate bolts and insulated joints','Geismar','Drill Hornet PR2','Project rail intervention and renewal','-','OB',1,1450,'7 years','Project/depot portable rail drill for rail web bolt-hole drilling during insulated joint installation, fishplate repairs and planned renewal work, not a routine team-carried asset.','https://geismar.com/produits/perceuse-de-rail-ultra-legere-et-pour-forets-ceux-drill-hornet-pr2/'],
  ['e05','E','COLLECTIF','Portable inverter generator 2kVA - silent - 230V - track possessions','Honda','Honda EU22i','Shared team support','-','RC',1,1250,'7 years','Power supply for portable equipment during possessions on non-electrified or dead sections.','https://www.honda.co.uk/power-products/generators/eu22i.html'],
  ['e06','E','COLLECTIF','LED floodlight set 100W - tripod - IP65 - night possession work','Peli','Peli 9430 RALS','Shared team support','-','RC',2,285,'7 years','Area lighting for track maintenance during night possessions. Two units provide adequate illumination for a single work zone.','https://www.peli.com/en/product/lights/remote-area-lighting/'],
  ['e08','E','DIAG','Digital track gauge with electronic cant (superelevation) - +/-1mm - Bluetooth - EN 13848','Goldschmidt','Trackgauge Digital (TGD)','Track geometry control','EN 13848','OB',1,1850,'10 years','Digital track and switch geometry gauge for gauge, cant and related checks with app-based recording and reporting.','https://www.goldschmidt.com/en/product/trackgauge-digital/'],
  ['e09','P','OUTILS','Portable battery-powered screwing machine - tirefonds + clip fasteners - Geismar Mantis','Geismar','Geismar Mantis Activion battery screwing machine','Project track fastening and bolting','-','OB',1,3800,'7 years','Project/depot battery-powered screwing machine for tirefonds and fishplate bolts during planned intervention, heavy corrective work and organised renewal activity rather than daily team carry.','https://geismar.com/produits/cle-a-chocs-sur-batterie-mantis/'],
  ['e11','E','DIAG','Rail head wear gauge - vertical + lateral wear - mechanical template type - 60E1/UIC60 - plain track','ROBEL','ROMEAS 85.01 SKM','Rail and profile inspection','-','OB',1,450,'10 years','Measurement of vertical and lateral rail head wear on plain track to relevant rejection limits.','https://www.robel.com/en/maschinen-werkzeuge-anwendungen/'],
  ['e14','E','DIAG','Straightedge 1 m + feeler gauge set - rail surface evenness - post-weld QC','Goldschmidt / Robel','Goldschmidt RAILSTRAIGHT COMPACT / Robel straightedge 1m','Rail and profile inspection','-','OB',1,480,'10 years','Post-weld running-surface evenness check before line reopening or acceptance.','https://www.gt-railservice.com/en/portfolio/measurement/measurement-devices/'],
  ['e15','E','OUTILS','Torque wrench 1/2" 40-200 Nm COFRAC - medium-range rail hardware','Facom','Facom S.307A200','Track fastening and bolting','-','OB',1,389,'10 years','Controlled tightening of medium-range rail and turnout hardware where traceable torque is required.','https://www.facom.com/product/s307a200/12-digi-cal-mechanical-torque-wrench-removable-ratchet-attachment-14-x-18-range-40-200nm'],
  ['e16','E','OUTILS','Impact socket set for track fasteners - 23 mm railway profile','Cengar','7823SP 23 mm Square Geismar Quick Release','Track fastening and bolting','-','OB',1,145,'5 years','Impact socket for Geismar-type railway screwing machines and battery fastening tools using the 23 mm railway fastener profile during track bolting work.','https://cengarimpactsockets.com/geismar-drive/'],
  ['e17','E','OUTILS','Turnout gauge (règle ADV) - mechanical - gauge + check rail + flangeway + switch opening','Pouget Rail','SW-9182','Switch and turnout maintenance','-','OB',1,380,'10 years','Mechanical turnout inspection gauge for gauge, check rail, flangeway and switch-opening checks during routine turnout maintenance and acceptance control.','https://www.pougetrail.com/en/products-page/mesures-et-controles/regles-de-controle-des-appareils-de-voie/'],
  ['e18','E','OUTILS','Digital switch tongue wear gauge - vertical wear measurement for turnouts','PIE','PSWG-1','Switch and turnout maintenance','-','OB',1,490,'10 years','Digital wear gauge used to measure switch tongue wear during turnout inspection and acceptance campaigns.','https://paragoninstruments.com/railway-measurement/digital-switch-rail-vertical-wear-measuring-gauge-model-pswg-1/'],
  ['e19','E','OUTILS','Portable tool container with shoulder strap - dedicated switch machine team bag','Wera','Wera 2go 2 Tool Container','Switch and turnout maintenance','-','OB',1,115,'5 years','Shared team container used to carry switch machine hand tools, fixing sets, gauges and small electrical accessories between cabinets and turnout work fronts.','https://www.wera.de/en/tools/wera-2go-2-tool-container'],
  ['e20','E','OUTILS','18V hammer drill/driver for switch machine supports and enclosure fixings','Bosch Professional','GSB 18V-55 Professional','Switch and turnout maintenance','-','RC',1,355,'7 years','Shared team hammer drill/driver for switch machine support brackets, enclosure fixings, anchor drilling and heavier field fastening tasks around turnout equipment.','https://www.bosch-professional.com/fr/fr/products/gsb-18v-55-06019H5301'],
  ['e21','E','OUTILS','Gauge-holding bar - electrically insulated - under-rail type - 1435 mm','Pouget Rail','111','Switch and turnout maintenance','-','OB',2,185,'10 years','Electrically insulated under-rail gauge-holding bar used to maintain correct track gauge during switch maintenance, clip replacement and rail realignment in track-circuit areas.','https://www.pougetrail.com/en/products-page/levage-et-dressage-de-voies/barres-de-maintien-decartement/'],
  ['e22','E','OUTILS','Switch lock key (cle d\'aiguillage) + extension handle','Pouget Rail','Switch Rail Key Lock','Switch and turnout maintenance','Supplier quote','OB',2,45,'10 years','Manual operation and locking of switch points during maintenance possessions. Reference kept generic pending exact switch-key configuration confirmation.','https://www.pougetrail.com/catalogues/rubriques/en/HandTools/HTML/files/assets/common/downloads/publication.pdf'],
  ['e23','E','OUTILS','18V Angle Grinder 125 mm','Bosch Professional','GWS 18V-15 SC Professional','Track intervention and renewal','-','RC',1,195,'7 years','Shared cordless grinder for seized fasteners, rust removal, rail accessory preparation, weld prep and general deburring.','https://www.bosch-professional.com/gb/en/products/gws-18v-15-sc-06019H6100'],
  ['e24','E','LEVAGE','Mechanical rail jack - 15t capacity - ratchet type - EN 13231 / FEM','Simplex','Simplex A17 mechanical track jack 15t','Rail positioning and lifting','EN 13231','OB',1,683,'10 years','Mechanical ratchet rail jack for lifting one rail locally during tamping support, sleeper exchange and short-track geometry adjustment.','https://www.railwaypartsdepartments.com/product/simplex-track-jack-a17-jacks-track-tools/'],
  ['e25','E','LEVAGE','Rail slewing bar (pince à riper) - lever type - lateral rail alignment','Pouget Rail / Geismar','Pouget Rail pince à riper standard / Geismar track slewing lever','Rail positioning and lifting','-','OB',2,95,'10 years','Lateral alignment of rail and track panel by lever action on the rail foot.','https://www.pougetrail.com/en/products-page/outillage-a-main/pinces-a-riper/'],
  ['e26','E','LEVAGE','Rail tongs (tenailles à rail) - clamp-on + carry - for short rail handling','Pouget Rail / Geismar','Pouget Rail tenailles portatives / Geismar rail tongs','Rail positioning and lifting','-','OB',2,85,'10 years','Safe manual handling of short rail sections during corrective maintenance and emergency repairs.','https://www.pougetrail.com/en/products-page/outillage-a-main/tenailles-et-pinces-a-rails/'],
  ['e27','E','DIAG','Dye penetrant (PT) inspection kit - rails and welds - EN ISO 3452','Magnaflux / Ardrox','Magnaflux Spotcheck SKL-SP2 kit / Ardrox 9PR penetrant','Rail and weld inspection','EN ISO 3452','RC',1,275,'N/A','Surface crack detection on rail welds, switch tongue tips, frog noses and other stress-concentration zones.','https://www.magnaflux.com/Magnaflux/Products/'],
  ['e28','E','CONSUM','Rail switch lubricant applicator - portable switch lubricator - tongue slide plates','LUBCON','SL 60 switch lubricator system','Track maintenance consumables','-','RC',1,185,'5 years','Portable applicator used for clean lubrication of switch slide plates, tongue rail base contact areas and similar turnout friction points during routine maintenance. Current price kept as an internal estimate pending supplier quote for the exact package.','https://www.lubcon.com/rail'],
  ['e29','E','CONSUM','Rail gauge face grease - bulk pail 25 kg - manual brush or applicator use','BECHEM','Ecorail 5501','Track maintenance consumables','-','RC',1,470,'N/A','Bulk biodegradable rail grease for gauge-face lubrication, exposed rail-side contact areas and manual brush application on curves or local friction points. Suitable for manual brush work as well as larger lubrication systems. Current price is an estimated budget placeholder pending supplier quote for the exact pack format.','https://www.bechem.de/fr/produits/graisses/bechem-ecorail-5501.html'],
  ['e30','E','CONSUM','Penetrating Rust Release Aerosol pack of 3 - seized fasteners','Wurth','Wurth 0890 200 004','Track maintenance consumables','-','RC',4,28,'N/A','Penetrating spray for seized tirefonds, fishplate bolts and rail anchor bolts before dismantling.','https://www.wurth.co.uk/rost-off-plus'],
  ['e31','E','CONSUM','Rail marking paint aerosol 500 ml + paint sticks - defect/maintenance marking - trackside use','Soppec','Track Marker 500 ml','Track maintenance consumables','-','RC',1,28,'N/A','Trackside marking of defects, measurement reference points, weld locations and inspection records using a clearly visible rail-compatible marking paint and companion paint sticks.','https://www.rmtools.eu/shop/46-2-141217-track-marker-yellow-marking-paint-soppec-500ml-10885'],
  ['e32','E','MBTDC','Portable Insulation Tester 500V / 1000V','Fluke','1507 Insulation Tester','Track circuit and bonding','IEC 61557-2 – CAT IV 600V','RC',1,699,'10 years','Shared insulation tester for insulated joints, rail-to-rail isolation checks and track-circuit insulation verification before return to service.','https://www.fluke.com/fr-fr/produit/testeurs-isolement/fluke-1507'],
  ['e33','P','MBTDC','Low-resistance bond continuity tester / micro-ohmmeter for rail bonds','Megger','DLRO10X','Track circuit and bonding','-','RC',1,4615,'8 years','Project-level low-resistance micro-ohmmeter for rail-bond continuity, impedance bonds and traction return connection integrity during detailed campaigns, acceptance checks and specialist fault analysis.','https://www.euro-index.nl/en/product/megger-dlro10x/'],
  ['e40','P','OUTILS','Portable battery rail cutter - cold saw type - 60E1 / UIC54 to UIC60 - no heat','Geismar','Shark Activion battery rail saw','Project rail intervention','-','RC',1,2200,'7 years','Portable battery rail saw for cold cutting of rail profiles during project intervention and controlled renewal work.','https://geismar.com/wp-content/uploads/2023/09/Geismar_Leaflet_Shark_Activion_EN.pdf'],
  ['e41','P','COLLECTIF','Mobile Workshop Roller Cabinet 6 drawers','Beta Tools','RSC24A/6','Project and depot support','-','RC',1,669,'10 years','Shared rolling cabinet for gauges, instruments, consumables and track team workshop tooling in a standardised drawer-based format.','https://www.beta-tools.com/en/mobile-roller-cab-with-6-drawers-with-anti-tilt-system.html'],
  ...
  // Technician AFC
  ['t01','T','PPE','ESD wrist strap + grounding mat ISO 61340-5-1 electronics workbench','Desco','16475 Portable Field Service Kit 18 x 22 in','AFC - Safety / PPE','-','OB',1,82,'Annual (visual)','Portable ESD field service kit for AFC electronics work: dissipative mat, wrist strap and ground lead. Used before opening validator, TVM, gate or reader electronic modules to avoid latent ESD damage.','https://www.testequity.com/brand/Desco/category/Static-Control/ESD-Safe-Matting/ESD-Safe-Field-Service-Kits'],
  ['t02','T','PPE','Safety glasses EN166 + antistatic nitrile gloves electronics handling','Bolle Safety / Ejendals','COBPSI + Tegera 84501 box of 100','AFC - Safety / PPE','-','OB',1,22,'Replace if worn','Eye protection during IPA cleaning of print heads and mechanisms. Antistatic nitrile gloves for PCB handling without ESD risk and protection against IPA solvent. Used at every maintenance intervention involving chemical cleaning or board handling.','https://www.bollesafety.com/en-int/sport/cobra'],
  ['t03','T','LOTO','Personal electrical LOTO kit - padlock, hasp, breaker lockouts and tags - TVM power isolation','Brady','120886','AFC - Lockout/LOTO','-','OB',1,109,'Annual inspection','Standardised personal electrical lockout kit for isolating TVM, gate and AFC cabinet supplies before internal electrical work. Aligned with the simulator electrical LOTO baseline rather than a mixed Brady/Master Lock bundle.','https://www.bradyid.com/products/personal-lockout-kit-electrical-pid-120886'],
  ['t04','T','MBTDC','TRMS multimeter CAT III 600V with NCV - AFC electrical troubleshooting','Fluke','117','AFC - Electronic Test & Measurement','Calibration required','OB',1,349,'Annual (calibration)','Baseline AFC field multimeter for TVM and fare gate power supplies, continuity checks, PSU output verification and control wiring troubleshooting. Standardised on Fluke 117 to avoid over-specifying a Fluke 87V for routine AFC field work.','https://www.fluke.com/fr-fr/produit/multimetres/multimetres-numeriques/fluke-117'],
  ['t06','T','OUTILS','Precision screwdriver bit set - Torx T6-T40, tamper-resistant Torx, Phillips, Pozidriv and slotted','Wera','Kraftform Kompakt 70 Universal 05057113001','AFC - General Tooling','-','OB',1,71,'Replace if worn','Shared standard precision/bit screwdriver baseline for AFC covers, anti-tamper public-facing screws, module fixings and confined TVM/fare-gate cabinet access. Keeps the AFC anti-tamper Torx need while using a single traceable Wera reference.','https://www.wera.de/en/05057113001'],
  ['t07','T','OUTILS','Hex key set metric 1.5-10 mm - AFC cabinet and module fixings','Wera','950/9 Hex-Plus Multicolour 1 SB','AFC - General Tooling','-','OB',1,42,'Replace when worn','Standard metric hex key set for AFC internal module fixings, validator brackets, gate covers and cabinet hardware. Imperial keys remain vendor-specific if a network has older imported equipment.','https://www.wera.de/fr/outillages/950-9-hex-plus-multicolour-1-sb-jeu-de-cles-males-coudees-syst-metrique-blacklaser'],
  ['t08','T','OUTILS','VDE 1000V insulated pliers set - cabling and AFC harness work','Knipex','00 20 12 VDE','AFC - General Tooling','-','OB',1,145,'Annual (visual inspection)','Standardised insulated pliers set for AFC cabinet wiring, connector handling, cable tie replacement and small harness work around LV supplies and control wiring.','https://www.knipex.com/en/products/002012'],
  ['t09','T','OUTILS','Rechargeable work light 500 lm magnet IP65 - enclosed cabinet work','Scangrip','UNIFORM 03.6208','AFC - General Tooling','-','OB',1,89,'Annual (battery check)','Standardised rechargeable inspection light for deep TVM enclosures, fare-gate interiors and communication cubicles. Magnetic and hook mounting support hands-free cabinet work.','https://www.scangrip.com/fr-fr/boutique/lampes-de-travail/03-6208-uniform'],
  ['t10','T','DIAG','Near-IR detector card 800-1700 nm - fare gate photocell beam presence check - passive indicator','Newport','F-IRC2-S IR Sensor Card','AFC - Fare Gate','-','OB',2,115,'Replace if damaged','Passive near-IR card for confirming the presence and approximate direction of AFC fare-gate IR photocell beams, typically around 850/940 nm. It is only a quick beam-presence aid; final alignment and signal validation remain through the gate diagnostics.','https://www.newport.com/p/F-IRC2-S'],
  ['t11','T','DIAG','Manual release key triangle 8 mm + vendor-specific fare gate bypass','AFC manufacturer','Standard triangle 8mm key + manufacturer-specific key (per network)','AFC - Fare Gate','-','OB',1,45,'Replace if lost','Manual unlocking of fare gates for maintenance mode access (bypasses electronic control). Required to open gate internals without electrical supply. Triangle 8 mm key covers most European fare gates (IER/Easier, Automatic Systems, Gunnebo). Vendor-specific key for recent high-security models. One set per technician loss must be reported immediately.','https://www.automatic-systems.com/'],
  ['t12','T','DIAG','Ethernet cable tester - RJ45 wiremap, length and cable ID - AFC field cabling checks','Klein Tools','VDV501-851 Scout Pro 3 Starter Kit','AFC - Network & Communications','-','OB',1,92,'Replace when worn','Technician-level RJ45 cable tester for AFC field cabling: wiremap, length, cable ID, open/short/miswire and port blink. PoE/load and network qualification are intentionally handled by the team-level LinkIQ tester, not by the technician baseline.','https://www.kleintools.com/catalog/cable-testers-accessories/scout-pro-3-tester-starter-kit'],
  ['t13','T','DIAG','USB to RS232/RS485 serial adapter set + DB9 cable - legacy AFC equipment console access','FTDI','US232R-100-BLK + USB-RS485-WE cable','AFC - Network & Communications','-','OB',1,75,'Replace when worn','Console and diagnostic access kit for older AFC devices using RS232 and RS485 links. Uses true FTDI RS232 and RS485 cable families rather than a TTL-only cable reference.','https://ftdichip.com/products/us232r-100-blk/'],
  ['t14','T','PPE','Safety Shoes S3 ESD SRC mid-cut','PUMA Safety','KRYPTON MID 634200','AFC - station and technical-room work','EN ISO 20345 - S3 ESD SRC','OB',1,119.39,'2 years or replace when worn','Standardised safety footwear for AFC technicians working in stations, technical rooms, TVM areas and gate lines where toe protection, grip and ESD-compatible footwear are expected during daily maintenance routes.','https://www.puma-safety.com/eu/de/maenner/schuhe/sicherheitsschuhe/sicherheitsschuhe-s3/231/krypton-mid-puma-safety-sicherheitsschuhe-s3-esd'],
  ['t15','T','PPE','Hi-visibility Vest Class 2','Seton','CPS4375052','AFC - platform, concourse and public-area work','EN ISO 20471 Class 2','OB',1,9.9,'2 years','Baseline visibility PPE for AFC interventions in public station areas, platform interfaces and service windows where technicians must remain identifiable and visible to operations staff and passengers.','https://www.seton.fr/gilet-securite-haute-visibilite-2-ceintures.html'],
  ['t16','T','PPE','Hi-visibility bump cap - baseball style anti-bump cap','Portwest','PS59 AirTech Bump Cap','AFC - low-clearance cabinets and station technical rooms','EN 812','OB',1,18,'3 years or replace if damaged','Light head protection for AFC technicians working inside TVMs, fare-gate housings, low-clearance cable routes and station technical rooms. This is a bump cap for minor impacts against fixed objects, not a substitute for an EN 397 safety helmet where falling-object risk exists.','https://www.portwest.com/products/view/PS59'],
  ['t17','T','PPE','Hi-visibility Work Trousers Class 2','Portwest','PW340','AFC - station and technical-room work','EN ISO 20471 Class 2','OB',1,79,'2 years or replace when worn','Base high-visibility lower-body workwear for AFC daily maintenance in stations, concourses, platforms and technical rooms where visibility must be maintained beyond a simple vest.','https://www.lyreco.com/webshop/FRCH/pantalon-haute-visibilite-portwest-pw340-classe-2-orange-noir-taille-58-product-000000000016482764.html'],
  ['t18','T','PPE','Hi-visibility Short-sleeve Work Polo Class 2','Portwest','RT22','AFC - station and technical-room work','EN ISO 20471 Class 2','OB',1,24,'1 year or replace when faded','Base high-visibility upper-body workwear for AFC daily work in warm conditions, inspections and service windows where relying only on a loose vest is not the preferred permanent garment.','https://www.hiviskings.com/portwest-rt22-class-2-hi-vis-safety-polo-rt22'],
  ['t19','T','PPE','Hi-visibility Winter Bomber Jacket Class 3','Portwest','C465','AFC - exposed station, platform and access work','EN ISO 20471 Class 3 - EN 343','OB',1,69,'3 years or replace when damaged','Cold-weather high-visibility outer layer for AFC teams working on exposed platforms, station entrances, outdoor TVMs and night service windows where warmth and visibility are both required.','https://www.lyreco.com/webshop/FRLU/veste-bomber-hi-vis-portwest-c465-orange-bleu-marine-taille-m-la-piece-product-000000000007875167.html'],
  // Team AFC
  ['e01','E','DIAG','USB NFC smart card reader - ISO 14443 A/B diagnostic - protocol checks on laptop','ACS Technology','ACR1252U USB NFC Reader III','AFC - Advanced Electronics','-','OB',1,49,'Annual (inspection)','Desktop NFC reader for team-level AFC card diagnostics on maintenance laptop: UID/application readout, ISO 14443 A/B checks, DESFire/MIFARE test card validation and investigation of repeated reader rejection faults. ACR1252U is preferred over older ACR122U because it is current and NFC Forum certified.','https://www.acs.com.hk/en/products/342/acr1252u/'],
  ['e02','E','DIAG','Network cable + network tester - 10G qualification, PoE load test, VLAN and switch diagnostics','Fluke Networks','LinkIQ LIQ-100','AFC - Network Diagnostics','Calibration required','OB',1,2100,'Annual (functional check / calibration if required)','Team-level AFC infrastructure tester for Cat5e/Cat6 cable performance up to 10GBASE-T, PoE load class verification, VLAN/switch/port diagnostics and intermittent AFC communication faults. Replaces the discontinued CableIQ-style line with the current Fluke Networks LinkIQ family.','https://www.fluke.com/en-us/product/network-cable-testers/copper/linkiq-100'],
  ['e03','E','DIAG','Passive 10/100/1000Base-T network TAP - non-intrusive AFC protocol capture with Wireshark','Dualcomm','ETAP-2003','AFC - Network Diagnostics','-','OB',1,301,'Replace when worn','Portable passive gigabit TAP inserted between AFC equipment and switch for packet capture without interrupting service. Supports PoE pass-through and Wireshark capture for transaction latency, protocol fault and intermittent communication analysis.','https://www.dualcomm.com/collections/network-tap/products/usb-powered-10-100-1000base-t-network-tap'],
  ['e04','E','COLLECTIF','Rugged laptop Toughbook 55 Series + AFC vendor diagnostic software - SAE/line controller maintenance','Panasonic','TOUGHBOOK 55 mk3','AFC - Back-Office / Servers','-','OB',1,2595,'5-year replacement','Shared AFC diagnostic laptop for vendor tools, line controller access, log download, firmware updates, Ethernet/USB/serial adapters and configuration work. Standardised on the simulator Toughbook 55 baseline.','https://eu.connect.panasonic.com/de/en/products/toughbook/toughbook-55-series'],
  ['e05','E','COLLECTIF','12V SLA UPS battery tester - quick Ah capacity check for AFC cabinet and small server UPS batteries','ACT Meters','CHROME-IBT / ACT CHROME 12V SLA Intelligent Battery Tester','AFC - Back-Office / Servers','Calibration required','OB',1,287,'Annual calibration','Team-level quick capacity screening of 12V sealed lead-acid batteries used in AFC cabinets and small local UPS units. This is more appropriate for AFC than a heavy battery-bank analyzer; main station UPS acceptance still belongs to electrical/power specialists if outside AFC scope.','https://www.actmeters.com/products/battery-testing/act-chrome-12v-sla-intelligent-battery-tester/'],
  ['e06','E','COLLECTIF','Mobile workshop roller cabinet 6 drawers - AFC module storage and repair workspace','Beta Tools','RSC24A/6','AFC - Workshop / Team','-','OB',1,669,'Replace when worn','Standardised mobile workshop cabinet for AFC modules, diagnostic accessories, consumables and work-front tools, with drawer separation by equipment family and calibration status.','https://www.beta-tools.com/en/mobile-roller-cab-with-6-drawers-with-anti-tilt-system.html'],
  ['e08','E','MBTDC','TRMS AC/DC clamp meter 1000A with iFlex - AFC supply current diagnostics','Fluke','376 FC','AFC - Electronic Test & Measurement','Calibration required','OB',1,703,'Annual (calibration)','Shared team clamp meter for non-invasive current checks on TVM feeds, fare-gate supplies, barrier motor faults and abnormal load diagnosis. Kept at team level rather than one per technician.','https://www.fluke.com/fr-fr/produit/mesure-courant/pinces-amperemetriques/fluke-376-fc'],
  ['e26','E','MBTDC','Infrared thermometer -50 to +550 C - AFC PSU and motor hot-spot screening','Fluke','62 MAX+','AFC - Electronic Test & Measurement','Calibration required','OB',1,148,'Annual (check)','Shared team IR thermometer for quick thermal screening of TVM switched-mode supplies, fare-gate motors, loaded cables and cabinet breakers during AFC troubleshooting and preventive checks. Kept at team level because it is an occasional diagnostic instrument, not a personal daily tool.','https://www.fluke.com/fr-fr/produit/thermometres/thermometres-infrarouges/fluke-62-max'],
  ['e09','E','CONSUM','ESD-safe compressed air duster 400 mL PCB and sensor dust removal','Electrolube','EAD400D Air Duster 400 ml x3','AFC - Consumables & Cleaning','N/A (consumable)','OB',3,119,'N/A (consumable)','Dust removal from AFC PCBs, optical sensors in fare gates, coin mechanism channels, and thermal printer interior. Ticket paper fibres and coin dust clog optical sensors regularly. ESD-safe propellant (no static discharge risk on boards). Standard consumable for PM visits no compressor required.','https://www.silmid.com/us/cleaners/air-dusters/electrolube-ead-airduster-400ml-aerosol/'],
  ['e10','E','CONSUM','Coin validator cleaning consumable kit - small brush, damp lint-free cloth and sensor swabs - no lubricant on coin path','RS Pro / Techspray','Small ESD-safe brush + lint-free microfiber cloths + Techspray 2307-50 foam swabs','AFC - TVM Cash Mechanisms','N/A (consumable)','OB',1,45,'Quarterly (PM)','Preventive cleaning of coin validator path, optical sensors and accessible coin channels when the network operates cash-capable TVMs. Based on CPI Gryphon cleaning guidance: brush or compressed air for dust, damp cloth for the coin path, dry soft cloth for prisms and IPA cotton swabs only for cassette optical surfaces. Lubricant is not applied to the coin path unless explicitly required by the validator OEM.','https://www.techsprayeu.com/mini-tip-foam-swab-8'],
  ['e12','E','CONSUM','Banknote acceptor cleaning kit - Waffletechnology bill validator cleaning cards - box of 15','KICTeam','KW3-BMB15M / KW3-BCWB15M bill acceptor cleaning cards','AFC - TVM Cash Mechanisms','N/A (consumable)','OB',1,35,'Bi-monthly (PM)','Preventive cleaning of banknote validator optical lenses, transport path and belts where TVMs retain banknote acceptance. Uses bill-acceptor cleaning cards rather than a vague JCM/MEI kit line.','https://kicteam.com/product/waffletechnology-for-cash-acceptors-kw3-bcwb15m/'],
  ['e14','E','CONSUM','Thermal printer PM cleaning kit IPA cleaning cards + cleaning pens + swabs','KICTeam','K2-T26B25 thermal cards + KT-PJC2B12 cleaning pens','AFC - Consumables & Cleaning','N/A (consumable)','OB',1,45,'Monthly (PM)','Preventive maintenance of thermal print head and platen roller. Cards with IPA clean the full roller surface in one pass. Cleaning pens target the print head precisely for stubborn deposits in recessed areas. Swabs cover interior guides and sensors. Monthly or every 5,000 prints.','https://kicteam.com/product/cleaning-cards-for-thermal-printers-25ct-k2-t26b25-k2-t36b25-k2-t46b25/'],
  ['e15','E','CONSUM','Thermal test paper rolls - 58 mm and 80 mm BPA-free - printer functional test after PM','Thermal paper supplier / Kayoo / Selva','58 mm + 80 mm BPA-free thermal receipt roll test pack','AFC - Consumables & Cleaning','N/A (consumable)','OB',2,28,'N/A (consumable)','Printer functional test stock after thermal head or platen cleaning/replacement. Keep a small 58 mm and 80 mm BPA-free roll pack for AFC ticket/receipt printers; final roll dimensions must match the local TVM printer mechanism.','https://www.kayoo.eu/en/business-industry/office-supplies/paper-rolls/3423/thermal-rolls-80mm-x-80m-x-12mm-oe78mm-bpa-free'],
  ['e16','E','DIAG','Digital force gauge 50 N - fare gate barrier flap closing force - EN 16005 safety checks','SAUTER / KERN','FK 50','AFC - Fare Gate','Calibration required','OB',1,275,'Annual (calibration)','Team safety measurement instrument for fare-gate flap force after spring, motor or actuator work and during periodic passenger-safety checks. 50 N range is aligned to low-force barrier mechanisms.','https://www.kern-sohn.com/shop/en/products/measuring-instruments/force-gauges/FK-50-/'],
  ['e17','E','CONSUM','Fare gate lubricant silicone grease Molykote 111 + PTFE aerosol pivots and slides','Molykote / WD-40','MOLYKOTE 111 Compound 150 g + WD-40 Specialist PTFE 400 ml','AFC - Consumables & Cleaning','N/A (consumable)','OB',2,45,'N/A (consumable)','Lubrication of fare-gate flap pivots, slides and compatible rubber/plastic interfaces. Molykote 111 is used where silicone grease compatibility is required; PTFE aerosol is kept for exposed sliding surfaces only when allowed by the gate OEM maintenance procedure.','https://www.zoro.com/molykote-silicone-lubricantsealant-valve-tube-grease-molykote-111-compound-150g-53oz-tube/i/G912511226/'],
  ['e18','E','DIAG','NFC test card set - ISO 14443 A/B and common transit card technologies - MIFARE Classic/DESFire checks','FENTEC','NFC Card Testing Set','AFC - Validator / Reader','-','OB',1,119,'Annual (renewal)','Team-level NFC card set for contactless reader diagnostics, read-range checks and regression testing with common card technologies. Network-specific secured transport media must still be supplied by the operator for end-to-end transaction tests.','https://store.fentec.fi/product/nfc-card-testing-set/'],
  ['e20','E','CONSUM','Magnetic head cleaning card IPA pre-saturated ISO CR80 format box 25','KICTeam','K2-H80B50 card reader cleaning cards - box of 50','AFC - Consumables & Cleaning','N/A (consumable)','OB',1,31,'N/A (consumable)','Preventive cleaning of magnetic read/write heads in fare gates and TVMs. Magnetic oxide deposits from transit cards accumulate on heads, degrading read performance and causing unjustified passage refusals. Monthly or every 10,000 transactions per manufacturer guidance.','https://kicteam.com/product/cleaning-cards-for-card-readers-k2-h80p10-k2-h80b50/'],
  ['e21','E','CONSUM','IPA 99.7% isopropyl alcohol 500 mL bottles general electronics cleaning pack 4','Electrolube','ELIPA01L 99.9% IPA 1 L x2','AFC - Consumables & Cleaning','N/A (consumable)','OB',4,50,'N/A (consumable)','Universal electronics cleaning solvent for AFC components: thermal print heads, magnetic read heads, optical sensors, connector contacts and PCBs. Ultra-pure IPA is used for fast drying without residue and with ESD wipes or ESD swabs depending on surface type.','https://www.samaro.fr/en/product/electrolube-ipa/'],
  ['e22','E','CONSUM','IPA connector/electronics cleaning wipes - anti-static temporary effect - pack 100','Electrolube','EWI100 IPA Electrowipes pack of 100','AFC - Consumables & Cleaning','N/A (consumable)','OB',1,48,'N/A (consumable)','Pre-saturated IPA wipes for AFC connector, sensor and screen-adjacent cleaning where controlled dosage is preferable to loose liquid IPA. Electrolube EWI100 includes demineralised water giving a temporary anti-static effect and is suitable for connector cleaning.','https://www.rapidonline.com/electrolube-ewi100-ipa-electrowipes-pack-of-100-87-1066'],
  ['e23','E','CONSUM','ESD foam swabs pack 100 precision sensor and connector cleaning','Techspray / RS Pro','2307 foam swabs - pack planning equivalent 100 pcs','AFC - Consumables & Cleaning','N/A (consumable)','OB',1,57,'N/A (consumable)','Precision cleaning of recessed optical position sensors in thermal printers, SIM/SD card contacts on communication modules and PCB connectors. Foam tip reaches zones inaccessible to wipes; ESD-safe material is important near NFC antenna boards and processor modules.','https://www.techspray.com/techswabs'],
  ['e24','E','CONSUM','Contact cleaner spray non-conductive electrical contacts and connectors pack 2','CRC Kontakt Chemie','70013-AA KONTAKT 60 400 ml x2','AFC - Consumables & Cleaning','N/A (consumable)','OB',2,24,'N/A (consumable)','Cleaning of oxidised electrical contacts and spring connectors which degrade in station environments. Fast evaporation with no insulating residue. Used on distribution board terminal blocks, fare gate backplane connectors and coin mechanism wire harness connectors.','https://www.eve-electronics.com/crc-contact-chemie-kontakt-60-contact-cleaner-400-ml-1034471-70013-aa-1.html'],
  ['e25','E','CONSUM','Cable ties + identification labels + heat-shrink tubing refill kit - AFC cabinet wiring rework','Panduit / HellermannTyton','Panduit KP-HSTT1 heat-shrink kit + HellermannTyton T18R ties + self-laminating cable labels','AFC - Consumables & Cleaning','N/A (consumable)','OB',1,135,'N/A (consumable)','Cabinet wiring rework consumable kit for restoring cable management after AFC module replacement, harness modification or connector repair. Price corrected upward because the previous estimate covered only simple ties, not heat-shrink plus durable identification labels.','https://www.newark.com/panduit/kp-hstt1/heat-shrink-tubing-assortment/dp/39C2377'],
  ['e27','E','OUTILS','Portable tool container with shoulder strap - AFC team intervention bag','Wera','Wera 2go 2 Tool Container','AFC - General Tooling','-','OB',1,115,'5 years','Shared AFC team container used to carry the intervention toolset, electrical testers, cleaning consumables and small spare parts between stations, TVMs, fare gates and technical rooms. More practical than a rigid case for mixed indoor station maintenance rounds.','https://www.wera.de/en/tools/wera-2go-2-tool-container'],
  // Project AFC
  ['p01','P','DIAG','4-channel 50 MHz digital oscilloscope - AFC serial bus and PSU signal analysis','Rigol','DS1054Z','AFC - Advanced Electronics','Calibration required','OB',1,350,'Annual (calibration if used for acceptance)','Project/workshop oscilloscope for AFC serial buses, PSU noise, UART/I2C/SPI debug and board-level diagnostic work. 50 MHz and 4 channels are sufficient for most AFC low-speed diagnostic tasks without using the much more expensive POS portable Fluke ScopeMeter.','https://www.rigolna.com/products/digital-oscilloscopes/1000z/'],
  ['p02','P','DIAG','Temperature-regulated soldering station + hot-air rework station - AFC PCB component rework','Hakko','FX-951 + FR-810B','AFC - Advanced Electronics','-','OB',1,1100,'Annual functional check','Project/workshop electronics rework capability for AFC modules: controlled soldering plus hot-air SMD removal/rework. Corrects the previous Weller/Hakko line where the listed soldering stations did not actually include hot air rework.','https://hakkousa.com/products/rework/fr-810b-smd-hot-air-rework-station.html'],
  ['p03','P','DIAG','Regulated DC bench power supply 0-30 V / 0-5 A - controlled AFC module energisation','OWON','P4305','AFC - Advanced Electronics','Calibration required','OB',1,240,'Annual (calibration if used for acceptance)','Project/workshop bench PSU for controlled energisation of AFC modules at 5 V, 12 V and 24 V logic/control supply levels with current limiting before refitting to field equipment. Replaces discontinued/used Keysight E3631A as the baseline reference.','https://files.owon.com.cn/catalogue/Product_Catalog_Collection.pdf'],
  ],
  DEQ: [
  ...
  ['t24','T','CONSUM','Wire Rope Lubricant Aerosol 300 ml','Interflon','Fin Grease aerosol','Overhead crane rope maintenance','N/A (consumable)','RC',2,18,'N/A','Penetrating lubricant for overhead crane ropes to reduce corrosion and wear.','https://interflon.com/products/interflon-fin-grease-aerosol'],
  ...
  ['t33','T','CONSUM','Penetrating Rust Release Aerosol pack of 3','Wurth','0890 200 004','Seized fasteners','N/A (consumable)','OB',3,28,'N/A','Daily release spray for seized fasteners in harsh depot environments.','https://www.wurth.co.uk/rost-off-plus'],
  ['t34','T','CONSUM','Corundum Abrasive Cloth pack of 30','Bosch Professional','Expert C355 Sanding Sheets pack 30','Surface preparation','N/A (consumable)','OB',1,22,'N/A','For deburring, rust removal and surface prep before assembly or welding.','https://www.bosch-professional.com/gb/en/products/expert-c355/'],
  ...
  ['e22','P','DIAG','Digital Magnetic Level 360 deg','Mitutoyo','950-317 Pro 360','Level and alignment checks','Annual','RC',1,285,'8 years','Project/depot digital inclinometer for level, tilt and alignment checks on lifting columns, workshop machines and depot equipment before deeper mechanical adjustment or verification.','https://www.edmundoptics.com/p/pro-360-digital-protractor-01-degree-resolution/55663/'],
  ...
  ['e26','E','DIAG','Ultrasonic Leak Detector','UE Systems','Ultraprobe 100','Leak detection and airborne ultrasound','Annual (check)','RC',1,420,'8 years','For wash-plant leaks, hidden valve leakage and similar non-visible losses.','https://www.uesystems.com/product/ultraprobe-100-leak-detector/'],
  ...
  MEP: [
  ["t01","T","LOTO","Personal LOTO kit – padlock + insulated hasp + tags – electrical isolation","Brady","120886","LV electrical isolation","-","OB",1,109,"Annual (inspection)","Mandatory isolation of LV/MV circuits before any work on fan motors, lighting panels, escalator drive cabinets, HVAC units, and pump controls. Each technician applies their own personal padlock – no shared LOTO.","https://www.bradyid.com/products/personal-lockout-kit-electrical-pid-120886"],
  ["t02","T","SAFETY","4-gas personal monitor – O₂, CO, H₂S, LEL – confined space & tunnel entry","Draeger","Draeger X-am 2500 Ex/O2/CO/H2S","All MEP domains","-","RC",1,335,"Annual (calibration)","Mandatory for entry into tunnel ventilation shafts, underground sump pump chambers, confined spaces below grade, and gas boiler plant rooms. Monitors O₂ (deficiency in poorly ventilated shaft), CO (diesel/exhaust ingress and gas boiler flue spillage – replaces standalone CO clip-on), H₂S (sump/drainage), and LEL (flammable gas).","https://www.draeger.com/fr_fr/Products/X-am-2500"],
  ["t03","T","PPE","Electrical insulating gloves Class 0 (1000V) + leather protector – LV panel work","Ansell","Ansell ActivArmr RIG014B Class 0 + leather protector","All MEP domains","IEC 60903 Class 0","OB",2,85,"6-month (dielectric test)","Protection during live-panel work on lighting distribution boards, fan VFD cabinets (up to 400V AC), HVAC control panels, and pump starters. Class 0 rated to 1000V AC/1500V DC.","https://www.ansell.com/int/en/products/activarmr-electrical-insulating-gloves-class-0-rig014b"],
  ["t04","T","PPE","Safety glasses anti-scratch anti-fog","Bolle Safety","Cobra COBPSI","All MEP domains","EN 166 / EN 170","OB",1,22,"1 year or if scratched","Baseline eye protection for daily MEP work around rotating fan blades, electrical cabinets, dusty plant rooms and chemical cleaning operations.","https://www.bollesafety.com/en-int/sport/cobra"],
  ["t05","T","MBTDC","TRMS multimeter CAT III 600V with NCV - daily MEP electrical troubleshooting","Fluke","117","LV electrical maintenance","CAT III 600V","OB",1,349,"Annual (COFRAC)","Baseline MEP multimeter for daily troubleshooting on lighting circuits, fan auxiliaries, pump starters, HVAC control panels and 24 VDC / 230 VAC maintenance tasks. Standardised on Fluke 117 to align with other subsystems and avoid over-specifying a Fluke 87V for routine field work.","https://www.fluke.com/fr-fr/produit/multimetres/multimetres-numeriques/fluke-117"],
  ["t06","T","MBTDC","AC/DC clamp meter TRMS 600A – motor and pump current draw measurement","Fluke","376 FC","LV electrical maintenance","CAT III 1000V","RC",1,703,"Annual (COFRAC)","Non-invasive current measurement on fan motors (typically 2–50A depending on size), escalator traction motors (10–80A), sump pump motors (1–15A), and HVAC compressors. Abnormal current draw indicates mechanical overload, bearing failure, or electrical fault.","https://www.fluke.com/fr-fr/produit/mesure-courant/pinces-amperemetriques/fluke-376-fc"],
  ["t07","T","MBTDC","Non-contact voltage detector 90–1000V AC – safe live/dead screening","Fluke","Fluke 2AC","LV electrical maintenance","-","OB",1,44,"Annual (functional check)","Quick first-line live/dead screening on lighting circuits, fan MCBs and pump starters before connecting instruments or making contact. Used as an initial indication only, ahead of formal verification with the bipolar VAT tester.","https://www.fluke.com/en-gb/product/electrical-testing/voltage-testers/fluke-2ac"],
  ["t08","T","OUTILS","Basic pipe wrench set + basin wrench + adjustable spanner – depot plumbing","Ridgid / Bahco","Ridgid 31305 2-pipe wrench set 250+350mm / Bahco adjustable spanner","Depot plumbing / sump pumps","-","OB",1,95,"Replace if worn","Mechanical pipe work on depot distribution mains and sump pump discharge connections. Ridgid pipe wrenches for BSP threaded steel or stainless fittings (G½ to G2).","https://www.ridgid.com/eu/en/pipe-wrenches"],
  ["t09","T","MBTDC","Safety VAT bipolar absence-of-voltage tester 12-1000V AC/DC - formal prove-dead before contact","Chauvin Arnoux","Chauvin Arnoux C.A 773","LV electrical maintenance","IEC 61243-3","OB",1,290,"Annual (calibration)","Mandatory formal absence-of-voltage verification before contact on isolated lighting circuits, fan starters, pump panels, escalator control panels and HVAC distribution boards. Complements the non-contact detector, which is only a first screening tool and not the final safety proof.","https://www.chauvin-arnoux.com/en/node/9325"],
  ["t10","T","PPE","Hi-visibility bump cap - baseball style anti-bump cap","Portwest","PS59 AirTech Bump Cap","MEP indoor technical rooms and low-clearance areas","EN 812","OB",1,18,"3 years or replace if damaged","Light head protection for MEP technicians working in low-clearance plant rooms, under cable trays, inside HVAC voids and around technical-room obstacles. This is a bump cap, not a substitute for an EN 397 helmet where falling-object risk exists.","https://www.portwest.com/products/view/PS59"],
  ["t11","T","PPE","Safety Shoes S3 ESD SRC mid-cut","PUMA Safety","KRYPTON MID 634200","All MEP domains","EN ISO 20345 - S3 ESD SRC","OB",1,119.39,"2 years or replace when worn","Standardised safety footwear for depot workshops, plant rooms, technical rooms and station back-of-house areas where toe protection, grip and daily walking comfort are required.","https://www.puma-safety.com/eu/de/maenner/schuhe/sicherheitsschuhe/sicherheitsschuhe-s3/231/krypton-mid-puma-safety-sicherheitsschuhe-s3-esd"],
  ["t12","T","PPE","Hi-visibility Vest Class 2","Seton","CPS4375052","Depot circulation, station access and public-area work","EN ISO 20471 Class 2","OB",1,9.9,"2 years","Baseline visibility PPE for MEP interventions in depot traffic areas, station interfaces and any workfront where technician conspicuity is required.","https://www.seton.fr/gilet-securite-haute-visibilite-2-ceintures.html"],
  ["t13","T","PPE","Hi-visibility Work Trousers Class 2","Portwest","PW340","All MEP domains - depot and station work","EN ISO 20471 Class 2","OB",1,79,"2 years or replace when worn","Base high-visibility lower-body workwear for daily MEP maintenance in depots, stations and external access routes where visibility must be maintained during the whole intervention.","https://www.lyreco.com/webshop/FRCH/pantalon-haute-visibilite-portwest-pw340-classe-2-orange-noir-taille-58-product-000000000016482764.html"],
  ["t14","T","PPE","Hi-visibility Short-sleeve Work Polo Class 2","Portwest","RT22","All MEP domains - depot and station work","EN ISO 20471 Class 2","OB",1,24,"1 year or replace when faded","Base high-visibility upper-body workwear for warm-weather MEP operations, inspections and service windows where a loose vest is not the preferred permanent garment.","https://www.hiviskings.com/portwest-rt22-class-2-hi-vis-safety-polo-rt22"],
  ["t15","T","PPE","Hi-visibility Winter Bomber Jacket Class 3","Portwest","C465","All MEP domains - winter outdoor and exposed work","EN ISO 20471 Class 3 - EN 343","OB",1,69,"3 years or replace when damaged","Cold-weather high-visibility outer layer for outdoor MEP work, depot access routes, exposed technical buildings and winter call-outs where warmth and visibility are both required.","https://www.lyreco.com/webshop/FRLU/veste-bomber-hi-vis-portwest-c465-orange-bleu-marine-taille-m-la-piece-product-000000000007875167.html"],
  ["t16","T","PPE","Technical Work Sweatshirt / Mid-layer","Portwest","KX377","MEP workshop clothing","-","OB",1,45,"1 year","Mid-layer workwear for semi-heated workshops, ventilated plant rooms and exposed maintenance points where a durable technical sweatshirt is needed under hi-vis outerwear.","https://www.portwest.com/products/view/KX377/MGR"],
  ["t17","T","SAFETY","VDE 1000V insulated screwdriver set - slotted, Phillips, Pozidriv - 7 pcs","Wiha","36295 SoftFinish VDE Set","LV electrical maintenance","IEC 60900","OB",1,78,"Annual (visual inspection)","Daily insulated screwdriver set for work on terminal blocks, contactors, MCBs, VFD auxiliaries, control relays and field devices in lighting boards, HVAC panels, fan starters and pump cabinets.","https://www.wiha.com/int/en/tools/screwdrivers/sets/softfinish-electric-slimfix-slotted-phillips-screwdriver-set-with-slimbits-7-pcs./36295"],
  ["t18","T","SAFETY","VDE 1000V insulated pliers set - combination, long nose, side cutters - 5 pcs","Knipex","00 20 12 VDE","LV electrical maintenance","IEC 60900","OB",1,145,"Annual (visual inspection)","Core insulated pliers set for stripping, gripping, bending and cutting conductors during routine MEP electrical maintenance on motors, luminaires, HVAC controls and auxiliary LV panels.","https://www.knipex.com/products/tool-sets/tool-rolls-and-tool-cases/tool-roll-with-4-parts/002012V04"],
  ["t19","T","OUTILS","Hex key set metric 1.5-10 mm - workshop and equipment enclosure maintenance","Wera","950/9 Hex-Plus Multicolour 1 SB","All MEP domains","-","OB",1,42,"Replace when worn","Metric Allen key set for fan guards, motor terminal boxes, HVAC panels, pump couplings, access covers and miscellaneous OEM fasteners commonly found on MEP equipment.","https://www-de.wera.de/en/great-tools/hex-plus/"],
  ["t20","T","OUTILS","Combination spanner set metric 8-19 mm in roll-up pouch","Stahlwille","96401007","All MEP domains","-","OB",1,185,"Replace when worn","Daily spanner set for general mechanical maintenance on support brackets, anchors, pipe clips, fan assemblies, pump bases and equipment fixings across depot and station assets.","https://stahlwille.com/en_gb/products/detail/1114101-doppelmaulschluessel-satz-dobbelsteeksleutelset-open-jawed-spanner-set-sor0-8-10-13-17-19-22-mm"],
  ["t21","T","OUTILS","Compact 1/4 inch ratchet and socket set - mobile intervention set","Facom","R.360NANOPB","All MEP domains","-","OB",1,163,"Replace when worn","Compact socket set suited to service rounds where access is tight and the technician needs a light kit for covers, small brackets, terminal enclosures and light mechanical assemblies.","https://www.facom.com/product/r360nanopb/nano-14-set-38-pieces"],
  ["t22","T","OUTILS","Portable tool container with shoulder strap - daily MEP intervention bag","Wera","Wera 2go 2 Tool Container","All MEP domains","-","OB",1,115,"5 years","Soft-sided mobile tool container for carrying the daily MEP hand-tool baseline, meter, VAT tester, small consumables and paperwork between technical rooms, platforms, depots and back-of-house areas.","https://www.wera.de/en/tools/wera-2go-2-tool-container"],
  ["e01","E","DIAG","Digital manifold gauge set HP/LP + 3 hoses – refrigerant circuit diagnosis","Testo / Rothenberger","Testo 550i digital manifold / Rothenberger RM 4","HVAC / technical rooms","-","OB",1,485,"Annual (calibration)","Refrigerant circuit diagnosis on split AC units and close-control units: measures HP (high-pressure / condensing), LP (low-pressure / evaporating), computes superheat and subcooling against target values for the specific refrigerant. Identifies undercharge (low LP), overcharge (high HP), dirty condenser (elevated condensing pressure), or TXV malfunction.","https://www.testo.com/en-GB/testo-550i/p/0564-5501"],
  ["e02","E","OUTILS","Two-stage vacuum pump 71 L/min + micron gauge – evacuation before refrigerant charge","Robinair / JB Industries","Robinair 15301 / JB DV-85N","HVAC / technical rooms","-","OB",1,485,"Annual (oil change + inspection)","Deep vacuum evacuation of refrigerant circuits after opening for component replacement (compressor, TXV, drier). Target vacuum <200 microns (266 Pa) to remove residual moisture that would form acid and damage the compressor.","https://robinair.com/sites/default/files/documents/556679_en_rev_e_1.pdf"],
  ["e03","E","DIAG","Refrigerant electronic scale 50 kg + tare function – charge weight measurement","Fieldpiece / Rothenberger","Fieldpiece SRS2 / Rothenberger refrigerant scale 60 kg","HVAC / technical rooms","-","OB",1,285,"Annual (calibration)","Precise measurement of refrigerant charge quantity during recovery and recharge. F-gas regulation requires recording of refrigerant quantities recovered and recharged by weight (not by pressure alone).","https://www.fieldpiece.com/products/refrigerant-scale-with-wireless-jack-system-srs2/"],
  ["e04","E","CONSUM","Coil cleaning pressure sprayer + coil cleaner chemicals – condenser/evaporator PM","Various","Jetwave sprayer 12L / Nu-Brite coil cleaner + Coil Frost non-acid evaporator cleaner","HVAC / technical rooms","-","OB",1,145,"N/A (consumable)","Condenser and evaporator coil cleaning at PM inspection intervals (typically annual). Dirty condenser coils increase condensing pressure, reduce compressor efficiency, and increase energy consumption by 10–25%.","https://uk.rs-online.com/web/c/hvac-r/air-conditioning-components/"],
  ["e05","E","OUTILS","Hydraulic pipe pressure test pump 0–40 bar – heating system pressure test","Rothenberger","Rothenberger RP50-S / Rothenberger Super Test II","Heating / boiler room","-","OB",1,485,"Annual (calibration)","Pressure testing of heating circuit pipework after Level 2–3 repair or extension (new radiator run, heat exchanger replacement, valve bypass). Test pressure per BS 7593 / EN 806: 1.5× maximum working pressure held 1 hour minimum with no visible drop.","https://rothenberger.com/it-it/pompe-provaimpianti-per-tubazioni-di-acqua/pompa-di-prova-rp-50-s-60200/"],
  ["e06","E","OUTILS","Electric drain cleaning machine – 25m cable – Level 2–3 drain blockage clearance","Ridgid / Rothenberger","Ridgid K-45 / Rothenberger Rospidomatic 22","Depot plumbing / sump pumps","-","OB",1,685,"Annual (cable inspection)","Mechanical clearance of blocked depot drainage, inspection chamber pipes, and sump pump inlets. Rotating cable with cutter head breaks through grease blockages, root intrusions, and accumulated solids.","https://www.ridgid.com/eu/en/k-45"],
  ["e07","E","OUTILS","Electric pipe freezing unit 15–54mm copper – pipe isolation without system drain-down","Rothenberger","ROFROST Turbo II R290 2\" + 8 inserts, 230V","Depot plumbing / sump pumps","-","OB",1,1320,"Annual (inspection)","Localised pipe isolation by forming an ice plug in copper pipe (15–54mm OD) without draining the entire heating or water circuit. Used for valve replacement, pipe repair, or new connection without full system shutdown – critical at depot where full heating drain-down would take 4–8 hours and require system refill and inhibitor dosing.","https://rothenberger.com/us-en/products/freezing-electric/rofrost-ii-r290-2-8-inserts-230v-1500004196"],
  ["e08","E","COLLECTIF","Mobile Workshop Roller Cabinet 6 drawers","Beta Tools","RSC24A/6","All MEP domains","-","OB",1,669,"Replace when worn","Shared MEP roller cabinet with drawers for storing tools, testers, consumables and work-front equipment in a standardised workshop format. Drawers can be organised by domain: electrical measurement, HVAC/refrigeration, plumbing and rotating equipment maintenance.","https://www.beta-tools.com/en/mobile-roller-cab-with-6-drawers-with-anti-tilt-system.html"],
  ["e10","E","MBTDC","Insulation resistance tester 500V / 1000V DC (megohmmeter) – motor winding check","Fluke","1507 Insulation Tester","LV electrical maintenance","-","OB",1,699,"Annual (calibration)","Motor winding insulation test before recommissioning after rewinding or flood exposure. Tests fan motor windings, pump motor windings, and escalator traction motor insulation.","https://www.fluke.com/fr-fr/produit/testeurs-isolement/fluke-1507"],
  ["e11","E","DIAG","Air flow meter kit with differential pressure + vane probes - duct and grille airflow measurement","Testo","testo 440 dP Air Flow ComboKit 2 (0563 4410)","HVAC / technical rooms","-","OB",1,1935,"Annual (calibration)","Measurement of airflow velocity and volume flow in tunnel ventilation ducts and at fan discharge/suction. Verifies fan performance against design specification (typically 2–25 m/s in tunnel).","https://www.testo.com/en-UK/testo-440-delta-p-air-flow-combokit-2-with-bluetooth-r/p/0563-4410"],  ["e13","E","DIAG","Electronic refrigerant leak detector – F-gas / HFC / HFO – R410A, R32, R407C, R134a","Inficon / Testo","Inficon TEK-Mate / Testo 316-3","HVAC / technical rooms","-","OB",1,325,"Annual (calibration + sensor)","Detection of refrigerant leaks on split AC units and close-control units serving traction substations and signalling rooms. F-gas regulation (EU 517/2014) requires leak check at each service visit and after repair.","https://www.inficon.com/en/products/tek-mate-refrigerant-leak-detector"],
  ["e15","E","OUTILS","Telescopic lamp replacement pole set – 2 to 6 m – high-bay luminaire access","Unger / Ettore","Unger OptiLoc 3-section 6m pole / Ettore Super System pole","Lighting / station and depot","-","OB",1,95,"Replace if bent","Access to depot high-bay LED fittings (6–12 m mounting height) and station platform luminaires without mobile elevated work platforms for routine lamp and driver replacement. Fittings with adapters for tube lamps and recessed downlights.","https://www.ungerpro.com/en/products/opti-loc-aluminium-extension-pole-6m"],
  ["e16","E","CONSUM","Luminaire cleaning kit – IPA wipes + microfibre + soft brush + degreaser – PM cleaning","Various","3M cleaning wipes + Würth microfibre + Unger brush","Lighting / station and depot","-","OB",2,35,"N/A (consumable)","Preventive maintenance cleaning of luminaire diffusers, reflectors, and lens surfaces. Dust and insect accumulation on diffusers reduces lux output by 10–30% over 12 months.","https://uk.rs-online.com/web/c/electronics-cleaning/"],
  ["e17","E","DIAG","Non-contact tachometer – 10–100,000 RPM – fan speed measurement","Fluke","Fluke 930","Tunnel ventilation / HVAC","-","OB",1,475,"Annual (calibration)","Verification of fan rotational speed against VFD-commanded frequency and design nominal RPM. Detects belt slip (for belt-drive fans) or coupling slip (direct-drive).","https://www.fluke.com/en-us/product/building-infrastructure/hvac-tools/fluke-930"],
  ["e18","E","DIAG","Belt tension gauge (sonic) – poly-V and flat belts – belt drive fans","Gates","Sonic Tension Meter 550C","Tunnel ventilation / HVAC","-","RC",1,680,"Annual (calibration)","Non-contact measurement of belt tension by detecting natural frequency with a pluck. Converts frequency to belt tension in Newtons and compares to manufacturer specification.","https://www.gates.com/en_us/maintenance-tools/belt-maintenance/sonic-tension-meter.html"],
  ["e19","E","OUTILS","Fan bearing grease gun – high-pressure + IP-rated nozzle + grease cartridge","Lincoln Industrial / SKF","Lincoln Industrial 1162 + SKF LGEP 2 grease","Tunnel ventilation / HVAC","-","OB",1,95,"Replace seals every 2 yrs","Re-lubrication of fan motor bearings and fan shaft bearings at PM intervals defined by manufacturer (typically 2,000–8,000 hours). Over-lubrication as damaging as under-lubrication – grease gun with pressure gauge preferred.","https://uk.rs-online.com/web/c/pneumatic-tools-power-tools/grease-guns/"],
  ["e20","E","DIAG","Digital thermometer + 4 K-type probes – supply/return air, pipe surface, ambient","Testo / Fluke","Testo 176-T4 4-channel logger / Fluke 52 II","Depot plumbing / sump pumps","-","OB",1,285,"Annual (calibration)","Temperature measurement across HVAC and heating domains – single instrument replaces a separate heating thermometer. HVAC uses: supply/return air ΔT (typically 6–12°C cooling coil), refrigerant suction/discharge pipe surface (superheat/subcooling estimation), technical room ambient (traction substation limit 35–40°C, signalling room 20–26°C).","https://www.testo.com/en-GB/testo-176-t4/p/0572-1767"],
  ["e21","E","DIAG","Digital thermo-hygrometer – 0–100% RH – humidity check in technical rooms","Testo / Rotronic","Testo 610 / Rotronic HC2-S","HVAC / technical rooms","-","OB",1,125,"Annual (calibration)","Relative humidity monitoring in signalling rooms (target RH 45–65% to prevent condensation on PCBs), traction substations (limit typically <70% RH), and HVAC plant rooms. Excessive humidity triggers corrosion on busbars and electronic equipment.","https://www.testo.com/en-GB/testo-610/p/0560-0610"],
  ["e22","E","DIAG","Differential pressure gauge 0–2,500 Pa – filter ΔP and duct pressure measurement","Testo","testo 512-1","HVAC / technical rooms","-","OB",1,457,"Annual (calibration)","Measurement of filter pressure drop on AHUs and HVAC units to determine when filters require replacement. Typical clean filter ΔP: 30–80 Pa; replacement threshold: 150–250 Pa (per manufacturer spec).","https://www.testo.com/nl-NL/testo-512-1/p/0563-1512"],
  ["e25","E","CONSUM","Water quality test kit – inhibitor, pH, corrosion, turbidity – closed heating circuit","Fernox","Instant System Test 62698","Heating / boiler room","BS 7593:2019","OB",1,123.25,"N/A (consumable kit)","Annual on-site water-quality screening on closed heating circuits at depot. Used to assess inhibitor presence, pH balance, corrosion indicators and suspended solids/turbidity before deciding whether the circuit can remain in service, needs inhibitor top-up, or requires cleaning or remedial treatment.","https://fernox.com/product/instant-system-test/"],
  ["e27","E","CONSUM","Step chain lubricant – OEM synthetic chain oil for escalator PM","KONE Spares / OEM","KM50079295H01 synthetic chain oil","Escalators / station access","EN 115-1","OB",4,75,"N/A (consumable)","Step chain lubrication at PM intervals, typically every 1,000 operating hours or 3 months depending on the OEM maintenance programme. KONE identifies KM50079295H01 as escalator synthetic chain oil and states that auto-oiler canisters are to be filled with this oil. Correct lubricant viscosity and OEM compatibility matter: an unsuitable product can attract dirt, run off, or fail to protect the chain properly.","https://konespares.com/sales-and-support/technical-support-resources/kone-spares-lubrication-guide/"],
  ["e28","E","DIAG","Water pressure test gauge 0–16 bar + flexible hose + fittings – pipe pressure test","Rothenberger / Watts","Rothenberger pressure test kit / Watts FP pressure gauge kit","Depot plumbing / sump pumps","-","OB",1,125,"Annual (calibration)","Hydraulic pressure testing of repaired pipe joints, valve replacements, and new pipework at depot. BS EN 806 requires cold water systems tested to 1.5× working pressure for minimum 1 hour.","https://www.rothenberger.com/en_GB/products/pipe-installation/pressure-testing"],
  ["e30","E","CONSUM","PTFE thread tape + pipe jointing compound + compression fitting kit – plumbing repair","Henkel / Würth","Henkel LOCTITE 55 thread seal / Würth jointing compound + copper fitting assortment","Depot plumbing / sump pumps","-","OB",2,55,"N/A (consumable)","Sealing and repair of threaded and compression joints on depot plumbing (cold/hot water, compressed air, heating flow/return). PTFE tape for parallel threads; LOCTITE 55 for tapered fittings up to G2 BSP.","https://uk.rs-online.com/web/c/plumbing-hvac/pipe-fittings/"],
  ["e31","E","CONSUM","Asset identification labels – polyester self-laminating – heat/oil/UV resistant","Brady / HellermannTyton","Brady BMP61 polyester label roll / HellermannTyton TT4-108","All MEP domains","-","OB",1,55,"N/A (consumable)","Equipment identification labelling for all MEP assets: fan units (FAN-TUN-01 etc.), luminaire circuits (LTG-PLT-A01), escalator identification (ESC-01), HVAC units (HVAC-SR-01), sump pumps (PMP-DEP-01). Self-laminating polyester resists moisture, oil, and 120°C heat.","https://www.bradyid.eu/en-eu/product-lines/bmp61-label-printer/"],
  ["e32","E","CONSUM","Cable ties assorted + cable labels + heat-shrink sleeves – wiring identification","Panduit / HellermannTyton","Panduit KP-HSTT1 heat-shrink kit + HellermannTyton T18R ties + self-laminating cable labels","All MEP domains","-","OB",1,135,"N/A (consumable)","Cable management and labelling after maintenance interventions on all MEP systems. Replacement of broken cable ties in fan terminal boxes, HVAC control panels, and escalator drive cabinets.","https://www.newark.com/panduit/kp-hstt1/heat-shrink-tubing-assortment/dp/39C2377"],
  ["e33","E","MBTDC","Three-phase rotation tester 40-700V AC - motor phase-sequence verification before start-up","Fluke","Fluke 9040","LV electrical maintenance","EN 61557-7","OB",1,316,"Annual (calibration)","Verification of phase sequence after reconnection or motor replacement on tunnel fans, sump pumps, HVAC compressors and any 3-phase rotating equipment. Prevents reverse rotation, wrong air direction, pump no-flow condition and mechanical damage at first energisation.","https://www.fluke.com/en/product/electrical-testing/basic-testers/fluke-9040"],  ["e35","E","DIAG","Infrared thermometer -30 to +650 C - quick thermal screening of motors, panels and bearings","Fluke","Fluke 62 MAX+","Cross-domain diagnostics","-","RC",1,148,"Annual (check)","Quick first-line thermal screening of fan bearings, pump motors, escalator drives, HVAC compressors, electrical terminals and lighting panels. Used for routine PM and fault triage when a full thermal camera survey is not justified.","https://www.fluke.com/fr-fr/produit/thermometres/thermometres-infrarouges/fluke-62-max"],
  ["e36","E","OUTILS","Fine-range torque wrench 5-25 Nm with removable ratchet - controlled tightening on terminals and small assemblies","Facom","Facom R.306A25","LV electrical maintenance","-","OB",1,155,"Annual (COFRAC calibration)","Controlled tightening of terminal blocks, contactors, breaker terminals, VFD auxiliaries, HVAC electrical accessories and small mechanical fasteners where under-torque causes overheating and over-torque damages threads or housings.","https://www.facom.com/GLOBALBOM/XJ/E.306A200S/1/Instruction_Manual/EN/E.306_T1_EUR.pdf"],
  ["e37","E","OUTILS","Refrigerant recovery unit 230V oil-less - recovery before opening HVAC/refrigeration circuits (conditional)","Robinair / Rothenberger","Robinair RG3-230 / Rothenberger ROREC PLUS 230V","HVAC / technical rooms","-","OP",1,895,"Annual (inspection)","Only required if the MEP team opens refrigerant circuits internally at Level 3. Used to recover refrigerant before replacing compressors, valves, driers or other sealed-circuit components, in line with F-gas containment and recovery obligations.","https://www.robinair.com/products/rg3-portable-refrigerant-recovery-machine-230v"],
  ["e38","E","COLLECTIF","Refrigerant recovery cylinder dual-valve 27 L / 12.5 kg - dedicated recovered refrigerant bottle (conditional)","REFCO / HVAC-R supplier","REFCO REF-CYL / equivalent EN 13322-1 recovery cylinder","HVAC / technical rooms","-","OP",1,240,"Periodic inspection / recertification","Only required if refrigerant is recovered in-house. Dedicated recovery cylinder used with the recovery unit to receive recovered refrigerant safely, avoid venting and maintain traceability of recovered charge.","https://www.refco.ch/40%20Dokumente%20Produkte/20_Bedienungsanleitungen/REF-CYL-Manual/4686959_REF-CYL_Manual_en.pdf"],
  ["e39","E","OUTILS","Nitrogen pressure/leak test set 0-50 bar - regulator, hose and bottle connection for HVAC circuits (conditional)","ROTHENBERGER","ROTHENBERGER Nitrogen Set 1000003865","HVAC / technical rooms","-","OP",1,425,"Annual (inspection)","Only required if the MEP team performs sealed-circuit repairs internally. Used for dry pressure testing, leak testing, line flushing and nitrogen purge during brazing on refrigeration and air-conditioning circuits.","https://rothenberger.com/ch-it/kit-azoto/set-di-azoto-per-circuiti-di-refrigerazione-per-la-germania-1000003865"],
  ["e40","E","DIAG","Combustible gas leak detector - methane / propane local leak search on gas train and fittings (conditional)","ROTHENBERGER","ROTEST Electronic 4 complet 1000003199","Heating / boiler room","-","OP",1,285,"Annual (functional check / calibration)","Only required if the MEP team carries out internal Level 2-3 maintenance on gas-fired heating equipment. Used for local leak search on valves, unions, regulators, burner trains and accessible gas pipework.","https://rothenberger.com/fr-fr/produits/appareils-de-detection-des-fuites-pour-conduites-de-gaz/rotest-electronic-4-complet-1000003199"],
...
const TOOL_CONTEXT_OVERRIDES = {
  ...
  ...contextOverridesFor([
    ...
    'CAT:e11','CAT:e12','CAT:e13','CAT:e14','CAT:e15','CAT:e17','CAT:e18','CAT:e20','CAT:e22','CAT:e23','CAT:e24','CAT:e25',
  ], ['metro', 'tram', 'heavy']),
  ...contextOverridesFor([
    'CAT:e21',
  ], ['tram']),
  ...
  ...contextOverridesFor([
    'AFC:t01','AFC:t02','AFC:t03','AFC:t04','AFC:t06','AFC:t07','AFC:t08','AFC:t09','AFC:t10',
    'AFC:t11','AFC:t12','AFC:t13','AFC:t14','AFC:t15','AFC:t16','AFC:t17','AFC:t18','AFC:t19',
    'AFC:e01','AFC:e02','AFC:e03','AFC:e04','AFC:e05','AFC:e06','AFC:e08','AFC:e09','AFC:e10',
    'AFC:e12','AFC:e14','AFC:e15','AFC:e16','AFC:e17','AFC:e18','AFC:e20',
    'AFC:e21','AFC:e22','AFC:e23','AFC:e24','AFC:e25','AFC:e26','AFC:e27',
    'AFC:p01','AFC:p02','AFC:p03',
  ], ['metro', 'tram', 'heavy', 'apm']),
  'POS:e13': ['heavy'],
  'POS:e17': ['heavy'],
  'POS:e20': ['heavy'],
...
export const TOOLING_LIFECYCLE_DEFAULTS = {
  ...
  ...lifecycleDefaultsFor(['POS:t01', 'POS:t02', 'POS:t03', 'POS:t12', 'POS:t15', 'POS:t17'], {
    type: 'periodic_replacement',
    intervalValue: '84',
    intervalUnit: 'months',
    replacementRatio: '100',
  ...
  ...lifecycleDefaultsFor(['POS:e17', 'POS:e18', 'POS:e19', 'POS:e20', 'POS:e21', 'POS:e25', 'POS:e28', 'POS:e29', 'POS:e30', 'POS:e31'], {
    type: 'periodic_replacement',
    intervalValue: '84',
    intervalUnit: 'months',
    replacementRatio: '100',
  ...
  ...lifecycleDefaultsFor(['POS:t09', 'POS:t10', 'POS:t19', 'POS:t20', 'POS:t23', 'POS:t24', 'POS:t25', 'POS:t30', 'POS:t31', 'POS:t37', 'POS:t38', 'POS:t39', 'POS:e08', 'POS:e41', 'POS:e49', 'POS:e51'], {
  ...
  ...lifecycleDefaultsFor(['POS:e35', 'POS:e36'], {
    type: 'periodic_replacement',
    intervalValue: '120',
    intervalUnit: 'months',
    replacementRatio: '100',
  ...
  ...lifecycleDefaultsFor(['POS:t34', 'POS:t35'], {
    type: 'periodic_replacement',
    intervalValue: '60',
    intervalUnit: 'months',
    replacementRatio: '100',
  ...
  ...lifecycleDefaultsFor(['POS:e54'], {
    type: 'consumable',
    intervalValue: '12',
    intervalUnit: 'months',
    replacementRatio: '100',
    source: 'Estimated annual replenishment rule for electrical maintenance consumables',
    year: '2026',
    basis: 'estimated',
  }),
  ...
  ...lifecycleDefaultsFor(['DEQ:t11', 'DEQ:t24', 'DEQ:t33', 'DEQ:t34', 'DEQ:t35'], {
    type: 'consumable',
    intervalValue: '12',
    intervalUnit: 'months',
    replacementRatio: '100',
  ...
  ...lifecycleDefaultsFor(['CAT:t05', 'CAT:t11', 'CAT:t12', 'CAT:t13', 'CAT:t14', 'CAT:t15', 'CAT:t16', 'CAT:t17', 'CAT:t19', 'CAT:t25', 'CAT:e04', 'CAT:e05', 'CAT:e09', 'CAT:e10', 'CAT:e11', 'CAT:e12', 'CAT:e15', 'CAT:e20', 'CAT:e21', 'CAT:e22', 'CAT:e24'], {
    type: 'periodic_replacement',
    intervalValue: '120',
    intervalUnit: 'months',
    replacementRatio: '100',
  ...
  ...lifecycleDefaultsFor(['CAT:t21', 'CAT:t22', 'CAT:t23', 'CAT:e18', 'CAT:e25'], {
    type: 'consumable',
    intervalValue: '12',
    intervalUnit: 'months',
    replacementRatio: '100',
  ...
  ...lifecycleDefaultsFor(['TRACK:t05'], {
    type: 'periodic_replacement',
    intervalValue: '6',
    intervalUnit: 'months',
    replacementRatio: '100',
    source: 'Track workbook baseline - anti-vibration glove renewal',
    year: '2026',
    basis: 'estimated',
  }),
  ...lifecycleDefaultsFor(['TRACK:t04'], {
    type: 'periodic_replacement',
    intervalValue: '12',
    intervalUnit: 'months',
    replacementRatio: '100',
    source: 'Track workbook baseline - safety eyewear replacement',
    year: '2026',
    basis: 'estimated',
  }),
  ...lifecycleDefaultsFor(['TRACK:t01', 'TRACK:t02', 'TRACK:t06', 'TRACK:t08', 'TRACK:t09'], {
    ...
    intervalUnit: 'months',
    replacementRatio: '100',
    source: 'Track workbook baseline - technician PPE renewal cycle',
    year: '2026',
    basis: 'estimated',
  }),
  ...lifecycleDefaultsFor(['TRACK:t03'], {
    type: 'periodic_replacement',
    intervalValue: '36',
    intervalUnit: 'months',
    replacementRatio: '100',
  ...
  ...lifecycleDefaultsFor(['TRACK:t11', 'TRACK:t12', 'TRACK:t14', 'TRACK:t16', 'TRACK:t17', 'TRACK:e16', 'TRACK:e19', 'TRACK:e28'], {
    type: 'periodic_replacement',
    intervalValue: '60',
    intervalUnit: 'months',
    replacementRatio: '100',
    source: 'Track workbook baseline - 5-year asset life',
    year: '2026',
    basis: 'estimated',
  }),
  ...lifecycleDefaultsFor(['TRACK:t10', 'TRACK:t13', 'TRACK:e03', 'TRACK:e05', 'TRACK:e06', 'TRACK:e09', 'TRACK:e20', 'TRACK:e23', 'TRACK:e40'], {
    type: 'periodic_replacement',
    intervalValue: '84',
    intervalUnit: 'months',
    replacementRatio: '100',
    source: 'Track workbook baseline - 7-year asset life',
    year: '2026',
    basis: 'estimated',
  }),
  ...lifecycleDefaultsFor(['TRACK:e32', 'TRACK:e33'], {
    type: 'periodic_replacement',
    intervalValue: '96',
    intervalUnit: 'months',
    replacementRatio: '100',
    source: 'Track workbook baseline - 8-year test instrument life',
    year: '2026',
    basis: 'estimated',
  }),
  ...lifecycleDefaultsFor(['TRACK:e01', 'TRACK:e02', 'TRACK:e08', 'TRACK:e11', 'TRACK:e14', 'TRACK:e15', 'TRACK:e17', 'TRACK:e18', 'TRACK:e21', 'TRACK:e22', 'TRACK:e24', 'TRACK:e25', 'TRACK:e26', 'TRACK:e41', 'TRACK:e42', 'TRACK:e43'], {
    type: 'periodic_replacement',
    intervalValue: '120',
    intervalUnit: 'months',
    replacementRatio: '100',
    source: 'Track workbook baseline - 10-year durable asset life',
    year: '2026',
    basis: 'estimated',
  }),
  ...lifecycleDefaultsFor(['TRACK:e27', 'TRACK:e29', 'TRACK:e30', 'TRACK:e31'], {
    type: 'consumable',
    intervalValue: '12',
    intervalUnit: 'months',
    replacementRatio: '100',
    source: 'Track workbook baseline - consumable replenishment rule',
    year: '2026',
    basis: 'estimated',
  }),
  ...lifecycleDefaultsFor(['AFC:t02', 'AFC:t18'], {
    type: 'periodic_replacement',
    intervalValue: '12',
    intervalUnit: 'months',
    replacementRatio: '100',
    source: 'AFC workbook baseline - annual PPE renewal for glasses/gloves and hi-vis polo',
    year: '2026',
    basis: 'estimated',
  }),
  ...lifecycleDefaultsFor(['AFC:t14', 'AFC:t15', 'AFC:t17'], {
    type: 'periodic_replacement',
    intervalValue: '24',
    intervalUnit: 'months',
    replacementRatio: '100',
    source: 'AFC workbook baseline - safety footwear and hi-vis workwear renewal',
    year: '2026',
    basis: 'estimated',
  }),
  ...lifecycleDefaultsFor(['AFC:t16', 'AFC:t19'], {
    type: 'periodic_replacement',
    intervalValue: '36',
    intervalUnit: 'months',
    replacementRatio: '100',
    source: 'AFC workbook baseline - bump cap and winter jacket renewal',
    year: '2026',
    basis: 'estimated',
  }),
  ...lifecycleDefaultsFor(['AFC:t10'], {
    type: 'periodic_replacement',
    intervalValue: '36',
    intervalUnit: 'months',
    replacementRatio: '100',
    source: 'AFC workbook baseline - IR detector card replacement',
    year: '2026',
    basis: 'estimated',
  }),
  ...lifecycleDefaultsFor(['AFC:t01', 'AFC:t09', 'AFC:e01', 'AFC:e04'], {
    type: 'periodic_replacement',
    intervalValue: '60',
    intervalUnit: 'months',
    replacementRatio: '100',
    source: 'AFC workbook baseline - 5-year field electronics and IT refresh',
    year: '2026',
    basis: 'estimated',
  }),
  ...lifecycleDefaultsFor(['AFC:t06', 'AFC:t12', 'AFC:t13', 'AFC:e02', 'AFC:e03', 'AFC:e05', 'AFC:e16', 'AFC:p01', 'AFC:p02', 'AFC:p03'], {
    type: 'periodic_replacement',
    intervalValue: '96',
    intervalUnit: 'months',
    replacementRatio: '100',
    source: 'AFC workbook baseline - 8-year diagnostic and workshop asset life',
    year: '2026',
    basis: 'estimated',
  }),
  ...lifecycleDefaultsFor(['AFC:t03', 'AFC:t04', 'AFC:t07', 'AFC:t08', 'AFC:t11', 'AFC:e06', 'AFC:e08', 'AFC:e26'], {
    type: 'periodic_replacement',
    intervalValue: '120',
    intervalUnit: 'months',
    replacementRatio: '100',
    source: 'AFC workbook baseline - 10-year durable asset life',
    year: '2026',
    basis: 'estimated',
  }),
  ...lifecycleDefaultsFor(['AFC:e27'], {
    type: 'periodic_replacement',
    intervalValue: '60',
    intervalUnit: 'months',
    replacementRatio: '100',
    source: 'AFC baseline aligned with existing Wera 2go team-container use in the simulator',
    year: '2026',
    basis: 'estimated',
  }),
  ...lifecycleDefaultsFor(['AFC:e18'], {
    type: 'periodic_replacement',
    intervalValue: '24',
    intervalUnit: 'months',
    replacementRatio: '100',
    source: 'AFC workbook baseline - NFC and magnetic test card renewal',
    year: '2026',
    basis: 'estimated',
  }),
  ...lifecycleDefaultsFor(['AFC:e09', 'AFC:e10', 'AFC:e12', 'AFC:e14', 'AFC:e15', 'AFC:e17', 'AFC:e20', 'AFC:e21', 'AFC:e22', 'AFC:e23', 'AFC:e24', 'AFC:e25'], {
    type: 'consumable',
    intervalValue: '12',
    intervalUnit: 'months',
    replacementRatio: '100',
    source: 'AFC workbook baseline - consumable and test-media replenishment rule',
    year: '2026',
    basis: 'estimated',
  }),
  ...
  ...lifecycleDefaultsFor(["MEP:t02", "MEP:t07", "MEP:t22", "MEP:e02", "MEP:e13", "MEP:e19", "MEP:e21", "MEP:e40"], {
    type: "periodic_replacement",
    intervalValue: "5",
    intervalUnit: "years",
    replacementRatio: "100",
  ...
  ...lifecycleDefaultsFor(["MEP:t03", "MEP:t04", "MEP:t14", "MEP:t16"], {
    type: "periodic_replacement",
    intervalValue: "1",
    intervalUnit: "years",
    replacementRatio: "100",
  ...
  ...lifecycleDefaultsFor(["MEP:t10", "MEP:t15"], {
    type: "periodic_replacement",
    intervalValue: "3",
    intervalUnit: "years",
    replacementRatio: "100",
    source: "MEP workbook baseline - technician PPE renewal cycle",
    year: "2026",
    basis: "estimated",
  }),
  ...lifecycleDefaultsFor(["MEP:t11", "MEP:t12", "MEP:t13"], {
    type: "periodic_replacement",
    intervalValue: "2",
    intervalUnit: "years",
    replacementRatio: "100",
  ...
  ...lifecycleDefaultsFor(["MEP:e01", "MEP:e03", "MEP:e05", "MEP:e06", "MEP:e07", "MEP:e11", "MEP:e15", "MEP:e17", "MEP:e18", "MEP:e20", "MEP:e22", "MEP:e28", "MEP:e37", "MEP:e39", "MEP:p07"], {
    type: "periodic_replacement",
    intervalValue: "7",
    intervalUnit: "years",
    replacementRatio: "100",
  ...
  ...lifecycleDefaultsFor(["MEP:e04", "MEP:e16", "MEP:e25", "MEP:e27", "MEP:e30", "MEP:e31", "MEP:e32"], {
    type: "consumable",
    intervalValue: "12",
    intervalUnit: "months",
    replacementRatio: "100",
    source: "MEP workbook baseline - consumable replenishment rule",
    year: "2026",
    basis: "estimated",
  }),
  ...lifecycleDefaultsFor(["MEP:e35"], {
    type: "periodic_replacement",
    intervalValue: "8",
    intervalUnit: "years",
    replacementRatio: "100",
...
export const TOOLING_SERVICE_DEFAULTS = {
  ...
  ...serviceDefaultsFor(['POS:e35', 'POS:e36'], {
  ...
  ...serviceDefaultsFor(['TRACK:t10'], {
    type: 'calibration',
    cost: '55',
    source: 'Track workbook baseline',
    year: '2026',
    basis: 'estimated',
  }),
  ...serviceDefaultsFor(['TRACK:e01'], {
    type: 'inspection',
    cost: '65',
    source: 'Track workbook baseline - LOLER inspection',
    year: '2026',
    basis: 'estimated',
  }),
  ...serviceDefaultsFor(['TRACK:e02'], {
    type: 'calibration',
    cost: '145',
    source: 'Track workbook baseline aligned with Fluke 376 FC',
    year: '2026',
    basis: 'estimated',
  }),
  ...serviceDefaultsFor(['TRACK:e08'], {
    type: 'calibration',
    cost: '185',
    source: 'Track workbook baseline',
    year: '2026',
  ...
  ...serviceDefaultsFor(['TRACK:e11', 'TRACK:e14', 'TRACK:e18'], {
    type: 'calibration',
    cost: '55',
    source: 'Track workbook baseline',
    year: '2026',
  ...
  ...serviceDefaultsFor(['TRACK:e15'], {
    type: 'calibration',
    cost: '110',
    source: 'Track workbook baseline aligned with Facom S.307A200',
    year: '2026',
    basis: 'estimated',
  }),
  ...serviceDefaultsFor(['TRACK:e17'], {
    type: 'calibration',
    cost: '95',
    source: 'Track workbook baseline',
    year: '2026',
  ...
  ...serviceDefaultsFor(['TRACK:e24'], {
    type: 'inspection',
    cost: '65',
    source: 'Track workbook baseline - LOLER load test',
    year: '2026',
    basis: 'estimated',
  }),
  ...serviceDefaultsFor(['TRACK:e32', 'TRACK:e33'], {
    type: 'calibration',
    cost: '145',
    source: 'Track workbook baseline',
    year: '2026',
  ...
  ...serviceDefaultsFor(['AFC:t04'], {
    type: 'calibration',
    cost: '95',
    source: 'AFC workbook baseline',
    year: '2026',
    basis: 'estimated',
  }),
  ...serviceDefaultsFor(['AFC:e26'], {
    type: 'verification',
    cost: '45',
    source: 'AFC workbook baseline',
    year: '2026',
  ...
  ...serviceDefaultsFor(['AFC:e02'], {
    type: 'calibration',
    cost: '145',
    source: 'AFC workbook baseline for Fluke Networks LinkIQ',
    year: '2026',
    basis: 'estimated',
  }),
  ...serviceDefaultsFor(['AFC:e05'], {
    type: 'calibration',
    cost: '95',
    source: 'AFC workbook baseline for SLA battery tester',
    year: '2026',
    basis: 'estimated',
  }),
  ...serviceDefaultsFor(['AFC:e08'], {
    type: 'calibration',
    cost: '120',
    source: 'AFC workbook baseline aligned with Fluke 376 FC',
    year: '2026',
    basis: 'estimated',
  }),
  ...serviceDefaultsFor(['AFC:e16'], {
    type: 'calibration',
    cost: '55',
    source: 'AFC workbook baseline for 50 N force gauge',
    year: '2026',
    basis: 'estimated',
  }),
  ...serviceDefaultsFor(['AFC:p01', 'AFC:p03'], {
    type: 'calibration',
    cost: '95',
    source: 'AFC workbook baseline for project electronics test instruments',
    year: '2026',
    basis: 'estimated',
  }),
  ...serviceDefaultsFor(['MEP:t02', 'MEP:t06'], {
    type: 'calibration',
    cost: '120',
  ...
  ...serviceDefaultsFor(['MEP:t03'], {
    type: 'inspection',
    cost: '45',
    source: 'MEP workbook baseline for dielectric glove testing',
    year: '2026',
    basis: 'estimated',
  }),
  ...serviceDefaultsFor(['MEP:t05', 'MEP:e01'], {
    type: 'calibration',
    cost: '95',
    source: 'MEP workbook baseline',
    year: '2026',
  ...
  ...serviceDefaultsFor(['MEP:t09', 'MEP:e20', 'MEP:e40'], {
    type: 'calibration',
    cost: '65',
    source: 'MEP workbook baseline',
    year: '2026',
  ...
  ...serviceDefaultsFor(['MEP:e05', 'MEP:e10', 'MEP:e11', 'MEP:e13'], {
    type: 'calibration',
    cost: '85',
    source: 'MEP workbook baseline',
    year: '2026',
  ...
  ...serviceDefaultsFor(['MEP:e17', 'MEP:e21', 'MEP:e22', 'MEP:e36'], {
    type: 'calibration',
    cost: '45',
    source: 'MEP workbook baseline',
    year: '2026',
  ...
  ...serviceDefaultsFor(['MEP:e35'], {
    type: 'verification',
    cost: '35',
    source: 'MEP workbook baseline for annual IR thermometer check',
    year: '2026',
    basis: 'estimated',
  }),
...
const TOOL_IMAGE_OVERRIDES = {
  ...
  'CAT:e24': 'e43_bahco_1_478_08_1_2_ergo_engineering_file_set.jpg',
  ...
  'TRACK:t01': 't44_portwest_c465.jpg',
  ...
  'TRACK:e06': 'e07_peli_peli_9430_rals.webp',
  'TRACK:e15': 'e12_facom_s_307a200.jpg',
  'TRACK:e19': 't37_wera_wera_2go_2_tool_container.jpg',
  'TRACK:e20': 'e10_bosch_gsb_18v_55_professional.webp',
  'TRACK:e23': 'e19_bosch_professional_gws_18v_15_sc_professional.jpg',
  'TRACK:e30': 't33_wurth_0890_200_004.jpg',
  'TRACK:e32': 't12_fluke_1507_insulation_tester.jpg',
  'TRACK:e33': 'e21_megger_dlro10x.jpg',
  'TRACK:e41': 'e12_beta_tools_rsc24a.webp',
  'TRACK:e42': 'e49_facom_440_je25.jpg',
  'TRACK:e43': 'e43_bahco_1_478_08_1_2_ergo_engineering_file_set.jpg',
  'AFC:t02': 't02_bolle_safety_cobra_cobpsi.jpg',
  'AFC:t03': 't34_brady_120886.jpg',
  'AFC:t04': 't01_fluke_117.webp',
  'AFC:t07': 't20_wera_950.jpg',
  'AFC:t08': 't09_knipex_00_20_12_vde.jpg',
  'AFC:t09': 't27_scangrip_uniform_03_6208.jpg',
  'AFC:t14': 't40_puma_safety_krypton_mid_634200.jpg',
  'AFC:t15': 't05_seton_cps4375052.jpg',
  'AFC:t17': 't42_portwest_pw340.jpg',
  'AFC:t18': 't43_portwest_rt22.jpg',
  'AFC:t19': 't44_portwest_c465.jpg',
  'AFC:e04': 'e48_panasonic_toughbook_55_mk3.jpg',
  'AFC:e06': 'e12_beta_tools_rsc24a.webp',
  'AFC:e08': 't15_fluke_376_fc.jpg',
  'AFC:e26': 't18_fluke_62_max.jpg',
  'AFC:e27': 't37_wera_wera_2go_2_tool_container.jpg',
  "MEP:t01": "t34_brady_120886.jpg",
  "MEP:t04": "t06_bolle_safety_cobra_cobpsi.webp",
  "MEP:t05": "t01_fluke_117.webp",
  "MEP:t06": "t15_fluke_376_fc.jpg",
  "MEP:t09": "t03_chauvin_arnoux_c_a_773.jpg",
  "MEP:e08": "e12_beta_tools_rsc24a.webp",
  "MEP:t10": "t16_portwest_ps59_airtech_bump_cap.jpg",
  "MEP:t11": "t40_puma_safety_krypton_mid_634200.jpg",
  "MEP:t12": "t05_seton_cps4375052.jpg",
  "MEP:t13": "t42_portwest_pw340.jpg",
  "MEP:t14": "t43_portwest_rt22.jpg",
  "MEP:t15": "t44_portwest_c465.jpg",
  "MEP:t16": "t09_portwest_kx377.jpg",
  "MEP:t17": "t09_wiha_36295_softfinish_vde_set.jpg",
  "MEP:t18": "t09_knipex_00_20_12_vde.jpg",
  "MEP:t19": "t20_wera_950.jpg",
  "MEP:t20": "t38_stahlwille_96401007.jpeg",
  "MEP:t21": "t39_facom_r_360nanopb.jpg",
  "MEP:t22": "t37_wera_wera_2go_2_tool_container.jpg",
  "MEP:e10": "t12_fluke_1507_insulation_tester.jpg",
  "MEP:e07": "e07_rothenberger_rofrost_turbo_ii_r290_2_8_inserts_230v.jpg",
  "MEP:e18": "e04_gates_sonic_tension_meter_550c.jpg",
  "MEP:e19": "t25_lincoln_industrial_1162.webp",
  "MEP:e32": "e25_panduit_panduit_kp_hstt1_heat_shrink_kit_hellermanntyton_t18r_ties_self_laminating_cable_labels.jpg",
  "MEP:e33": "t16_fluke_9040.jpg",
  "MEP:e35": "t18_fluke_62_max.jpg",
  "MEP:e36": "e13_facom_r_306a25.jpg",
