...
const RAW_BY_SUBSYSTEM = {
  ...
  ['e31','P','DIAG','Radiometric Thermal Camera 640×480 – MSX WiFi','Fluke','Ti480 PRO','All domains','EN 13187 / IEC 60068-2','OB',1,12859,'Annual (COFRAC calibration)','Preventive inspection HV/LV/DC. Hot spots on breakers, cables, connections.','https://www.fluke.com/fr-fr/produit/cameras-thermiques/fluke-ti480-pro'],
  ...
  ['e06','E','DIAG','Thermal Imaging Camera 320x240 radiometric','Fluke','TiS60+','Preventive diagnostics','-','RC',1,3812,'Annual (COFRAC)','Thermographic inspection of operator motors, PCB hotspots and poor electrical connections.','https://www.fluke.com/fr-fr/produit/cameras-thermiques/fluke-tis60-plus'],
  ...
  ['t17','T','OUTILS','Engineer Hammer 500 g plus Soft-face Mallet 50 mm','Facom / Facom Expert','M.215A + E150304','Mechanical fitting work','Replace if worn','RC',1,42,'7 years','Used for freeing seized parts and seating components without damaging finished surfaces.','https://www.facom.com/fr-fr/products/hammers-and-mallets/'],
  ...
  ['t19','T','OUTILS','Adjustable Wrench 300 mm','Facom','111A.30','General mechanical maintenance','Replace if worn','RC',1,35,'10 years','Useful for non-standard fittings, plumbing and unexpected maintenance situations.','https://www.facom.com/fr-fr/products/wrenches/adjustable-wrenches/'],
  ['t20','T','OUTILS','Pin Punch Set 8 pcs','Facom','246H.J8PB','Mechanical extraction work','Replace if worn','RC',1,55,'10 years','For removing keys, pins, articulation hardware and seized mechanical retainers.','https://www.facom.com/fr-fr/products/hammers-and-mallets/punches/'],
  ['t21','T','OUTILS','Internal and External Circlip Pliers Set 4 pcs','Knipex','00 20 01 SB','Bearing and retention work','Replace if worn','RC',1,48,'10 years','Circlip service during compressor, crane, forklift and wheel-lathe bearing work.','https://www.knipex.com/en/products/002001sb'],
  ['t22','T','OUTILS','Cr-Mo Impact Socket Set 1/2 and 3/4','Facom','NK.E30PB + SL.E14PB','Impact bolting support','Replace if worn','RC',1,145,'10 years','Impact-rated sockets supporting heavy mechanical work with pneumatic tooling.','https://www.facom.com/fr-fr/products/sockets-and-ratchets/impact-sockets/'],
  ['t23','T','OUTILS','Bearing Puller Set 2 and 3-jaw','Facom','U.35J5 extractor set','Mechanical extraction work','Replace if worn','RC',1,165,'10 years','Extractor set for motors, pulleys, shafts and bearings on depot equipment.','https://www.facom.com/fr-fr/products/pullers-extractors/'],
  ['t24','T','OUTILS','Wire Rope Lubricant Aerosol 400 ml','Interflon','Fin Grease aerosol','Overhead crane rope maintenance','N/A (consumable)','RC',2,18,'N/A','Penetrating lubricant for overhead crane ropes to reduce corrosion and wear.','https://us.interflon.com/fin-grease-aerosol/9554'],
  ['t25','T','OUTILS','Pneumatic Grease Gun 500 cc','Lincoln Industrial','1162','Lubrication rounds','Annual (inspection)','OB',1,95,'7 years','Core lubrication tool for bearings, pivots, gears and routine PM tasks.','https://www.skf.com/group/products/lubrication/lubrication-tools/grease-guns/'],
  ['t26','T','OUTILS','Electric Vane Oil Pump 230V 30 L/min','Pressol','23 301','Fluid service work','Annual (inspection)','RC',1,185,'7 years','For oil transfer and drain operations on compressors, forklifts and rail-road vehicles.','https://www.pressol.com/TBGPortalService/data/items/6871448/print?categoryId=34041&imageView=Y&language=US&organizationId=83'],
  ['t27','T','OUTILS','Oil Recovery Tray 30 L with manual pump','Pressol','21 301','Fluid service work','Replace if worn','OB',2,55,'7 years','Used-oil recovery tray for clean drain operations and environmental protection.','https://uk.rs-online.com/web/c/fluid-transfer-storage/spill-containment/drip-trays/'],
  ['t28','T','OUTILS','Lever-action Manual Oil Drain Pump 8 L','Pressol','20 307','Fluid service work','Annual (inspection)','RC',1,65,'7 years','Manual oil extraction where drain plugs are inaccessible or no power is available.','https://uk.rs-online.com/web/c/fluid-transfer-storage/pumps/hand-pumps/'],
  ['t29','T','OUTILS','Low-profile Drain Pan 15 L','Pressol','21 116','Low-clearance drain work','Replace if worn','OB',1,38,'5 years','Low-clearance pan for vehicles and underside access in pits.','https://uk.rs-online.com/web/c/fluid-transfer-storage/spill-containment/drip-trays/'],
  ...
  ['t31','T','OUTILS','Oil Filter Remover Set strap plus 3-jaw','Facom','DM.115V','Filter service work','Replace if worn','RC',1,42,'10 years','For removing threaded oil filters on compressors, vehicles and hydraulic equipment.','https://www.facom.com/fr-fr/products/'],
  ['t32','T','OUTILS','Flexible Funnel Set with filter and anti-spill spout','Pressol','20 055','Clean fluid filling','Replace if worn','OB',1,18,'3 years','Filtered filling of compressor oil, hydraulics and coolant without contamination.','https://uk.rs-online.com/web/c/fluid-transfer-storage/funnels-scoops/'],
  ['t33','T','OUTILS','Penetrating Rust Release Aerosol pack of 3','Wurth','0893 200','Seized fasteners','N/A (consumable)','OB',3,28,'N/A','Daily release spray for seized fasteners in harsh depot environments.','https://www.wurth.co.uk/rost-off-plus'],
  ...
  ['t35','T','OUTILS','Industrial Degreaser Aerosol pack of 3','Wurth','0890 115 4','Cleaning and degreasing','N/A (consumable)','OB',3,25,'N/A','Residue-free degreasing before testing, reassembly, bonding or welding.','https://www.wurth.co.uk/brake-cleaner'],

  ['e01','E','LOTO','Multi-discipline Depot LOTO Station','Brady','148359 LOTO Station complete depot','Shared isolation resources','Annual (inspection)','OB',1,385,'10 years','Shared lockout station for major compressor, crane, wheel-lathe and multi-source isolations.','https://www.bradyid.eu/en-eu/lockout-tagout/lockout-stations/'],
  ...
  ['e03','E','DIAG','Thermal Imaging Camera TiS60+ 320x240','Fluke','TiS60+ Thermal Camera','Electrical and thermal diagnostics','Annual (accredited)','RC',1,3812,'8 years','Shared thermal camera for electrical panels, bearings, drives, couplings and hot-spot detection.','https://www.fluke.com/fr-fr/produit/cameras-thermiques/fluke-tis60-plus'],
  ...
  ['e11','E','COLLECTIF','7-drawer Lockable Tool Trolley','Stanley Tools','FMST1-75797 FatMax 7 drawers','Shared workshop storage','Replace if worn','RC',1,485,'10 years','Shared rolling cabinet for team instruments, gauges and workshop tooling.','https://www.stanleytools.com/fr-fr/'],
...
export const TOOLING_LIFECYCLE_DEFAULTS = {
  ...
  ...lifecycleDefaultsFor(['DEQ:t12', 'DEQ:t13', 'DEQ:t14', 'DEQ:t15', 'DEQ:t16', 'DEQ:t17', 'DEQ:t19', 'DEQ:t20', 'DEQ:t21', 'DEQ:t22', 'DEQ:t23', 'DEQ:t25', 'DEQ:t26', 'DEQ:t27', 'DEQ:t28', 'DEQ:t29', 'DEQ:t30', 'DEQ:t31', 'DEQ:t32', 'DEQ:t36'], {
    type: 'condition_based',
    intervalValue: '',
    intervalUnit: 'years',
    replacementRatio: '100',
...
const PRIMARY_USE_OVERRIDES = {
  ...
  e31: 'Project/depot radiometric thermal imaging camera for large-area inspection and condition-based maintenance. Use it during expert investigations, audits or deeper condition surveys to scan cabinets, transformers, switchgear, drives and cable terminations for hidden heating patterns before failure.',
