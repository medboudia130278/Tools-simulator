...
const RAW_BY_SUBSYSTEM = {
  ...
  ['t06','T','OUTILS','Precision screwdriver bit set - Torx T6-T40, tamper-resistant Torx, Phillips, Pozidriv and slotted','Wera','Kraftform Kompakt 70 Universal 05057110001','AFC - General Tooling','-','OB',1,71,'Replace if worn','Shared standard precision/bit screwdriver baseline for AFC covers, anti-tamper public-facing screws, module fixings and confined TVM/fare-gate cabinet access. Keeps the AFC anti-tamper Torx need while using a single traceable Wera reference.','https://www.wera.de/en/kraftform_kompakt_kraftform_kompakt_without_ratchet_functionality_kraftform_kompakt_70_and_71.html'],
  ...
  ['e07','E','COLLECTIF','Rugged Android tablet + CMMS software - maintenance work order and asset traceability','Samsung','Galaxy Tab Active5 Enterprise Edition 6+128GB Wi-Fi SM-X300NZGAN20','AFC - Workshop / Team','-','OB',1,460,'5-year (replacement cycle)','Team CMMS tablet for work orders, QR/barcode asset identification, photo evidence, procedures and maintenance traceability. Replaces the older Toughpad FZ-A3/Getac T800 line with a current rugged Android enterprise tablet; the Toughbook laptop remains the diagnostic PC.','https://www.samsung.com/fr/business/tablets/galaxy-tab-active/galaxy-tab-active5-green-128gb-enterprise-edition-sm-x300nzgaeeb-sm-x300nzgaeeb/'],
  ...
  ['e19','E','DIAG','Magnetic stripe test card set ISO 7810/7811 HiCo + LoCo TVM and gate mag readers','CardLogix / card supplier','HiCo 2750 Oe + LoCo 300 Oe encoded sample cards','AFC - Validator / Reader','-','OB',1,95,'Annual (renewal)','Verification of magnetic read/write heads on fare gates and TVMs. High-coercivity and low-coercivity sets cover both standards used across different network generations. Tests read, write test pattern and damaged-stripe detection. Format depends on gate generation.','https://www.cardlogix.com/product-category/cards/magnetic-stripe-cards/'],
...
const TOOL_CONTEXT_OVERRIDES = {
  ...
  ...contextOverridesFor([
    ...
    'AFC:e01','AFC:e02','AFC:e03','AFC:e04','AFC:e05','AFC:e06','AFC:e07','AFC:e08','AFC:e09','AFC:e10',
    'AFC:e12','AFC:e14','AFC:e15','AFC:e16','AFC:e17','AFC:e18','AFC:e19','AFC:e20',
    'AFC:e21','AFC:e22','AFC:e23','AFC:e24','AFC:e25','AFC:e26',
...
export const TOOLING_LIFECYCLE_DEFAULTS = {
  ...
  ...lifecycleDefaultsFor(['AFC:t01', 'AFC:t09', 'AFC:e01', 'AFC:e04', 'AFC:e07'], {
    type: 'periodic_replacement',
    intervalValue: '60',
    intervalUnit: 'months',
    replacementRatio: '100',
  ...
  ...lifecycleDefaultsFor(['AFC:e18', 'AFC:e19'], {
    type: 'periodic_replacement',
    intervalValue: '24',
    intervalUnit: 'months',
    replacementRatio: '100',
