...
const RAW = [
  ...
  ['t04','T','EPI','Insulating Gloves Class 0 (1000V AC) + leather protectors','Honeywell / Salisbury','GK014B/10H glove kit','LV / DC Traction','Class 0 – IEC EN 60903 / ASTM D120','OB',1,188,'6 months (dielectric test)','Official Salisbury glove kit page including class 0 rubber insulating gloves, leather protectors and storage bag for low-voltage intervention work.','https://www.salisburyshop.com/buy/product/class-0-black-rubber-insulating-glove-kit/198561'],
  ...
  ['t10','T','EPI','VDE 1000V Insulated Tool Set – 5 pcs','Knipex','00 20 13','LV','DIN EN/IEC 60900 – 1000V AC','OB',1,109,'Annual (visual inspection)','Official KNIPEX 5-piece VDE set combining insulated pliers and screwdrivers for standard low-voltage work.','https://www.knipex.com/products/tool-kits/tool-kits/tool-kits/002013'],
  ...
  ['t17','T','MBTDC','2-pole AC/DC Voltage & Polarity Tester 24-1500V DC','Gossen Metrawatt','METRAVOLT 12D+L','DC Traction 750-1500V / LV','DIN EN 61243-3 – CAT IV 600V / CAT III 1000V','RC',1,435,'Annual','Two-pole tester with continuity, phase sequence and polarity indication. Better match for traction DC polarity checks than the previous unrelated MI2124 reference.','https://www.gossenmetrawatt.de/produkte/mess-und-prueftechnik/prueftechnik/pruefung-elektrischer-installationen-und-anlagen/spannung-phase-drehfeld-durchgang-polaritaet/metravolt-12d-plusl/'],
  ...
  ['e09','E','OUTILS','Cordless Impact Wrench 18V 400 Nm 1/2"','Bosch','GDS 18V-400 Professional','MV / HV – Heavy bolting','–','RC',1,494,'Replace if defective','Official Bosch product page for the 400 Nm 1/2 inch impact wrench used on heavy bolting, busbars and transformer work.','https://www.bosch-professional.com/uy/es/products/gds-18v-400-06019K00E0'],
