...
const RAW_BY_SUBSYSTEM = {
  ...
  ['e40','E','CABLE','Armoured / Steel-Reinforced Cable Cutter – up to 32 mm','Knipex','95 32 340 SR','MV armoured cables / reinforced conductors','–','RC',1,320,'Annual (blade inspection)','Heavy-duty ratchet cable cutter for steel-reinforced or armoured conductors where a standard Cu/Al shear is not sufficient. More defensible and sourceable current reference than the obsolete Greenlee CS750 entry.','https://www.knipex.com/products/cable-and-wire-rope-shears/acsr-cable-cutter-ratchet-action-for-cables-with-a-steel-core'],
