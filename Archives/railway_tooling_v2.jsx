...
const RAW = [
  ...
  ['t05','T','EPI','Insulating Helmet + face shield Class E (20kV)','JSP','EVO3 REV','All domains','EN 397 – Classe E','OB',1,58,'3 years','With chin strap and integrated arc-flash face shield. Colour-coded by role.','https://www.jspsafety.com/fr/produits/protection-de-la-tete/casques/evo3-rev'],
  ...
  ['t07','T','EPI','Arc-flash Clothing Class 1 (4 cal/cm²)','Enespro / Salisbury','AGF40KIT','All domains','IEC 61482-2 – Classe 1','OB',1,320,'3 years or after arc event','Class 2 (8 cal/cm²) recommended for 25kV proximity work.','https://www.enespro.com/products/arc-flash-kits'],
  ['t08','T','EPI','Rechargeable ATEX Zone 2 Headlamp – 300 lm','Petzl','PIXA 3 ATEX E97P3','All domains','ATEX zone 2 – IECEx','OB',1,118,'Annual (battery)','For use in technical rooms, tunnels, substations.','https://pro.petzl.com/fr/pro/lampes-frontales-atex/pixa-3'],
  ...
  ['t14','T','MBTDC','Loop Impedance Meter NF C 15-100','Metrel','MI3102H EurotestXD','LV / Auxiliaries 400V','IEC 61557 – NF C 15-100','RC',1,420,'Annual (calibration)','Alternative to Fluke 1664FC when NF C 15-100 standard is mandated.','https://www.metrel.si/instruments/installation-testers/MI3102'],
  ...
  ['t16','T','MBTDC','Three-phase Rotation Tester 80-760V AC','Chauvin Arnoux','CA 6412','LV / Auxiliaries 400V','CAT IV 600V','OB',1,75,'Annual','Phase rotation check direct/reverse. Systematic use before energisation.','https://www.chauvin-arnoux.com/fr/produits/category/testeurs-electriques/ca-6412'],
  ...
  ['t19','T','OUTILS','Ratchet Set 1/4" + 3/8" + metric sockets 100 pcs','Wera','9100 SB RA','LV / MV – Bolting','ISO 2725 / DIN 3122','OB',1,165,'Replace when worn','Compact ratchet set. For cabinet fixings, lugs, terminals.','https://www.wera.de/fr-fr/products/sets/ratchet-sets/9100-sb-ra'],
  ['t20','T','OUTILS','Hex Key Set short + long metric 1.5-10mm','Wiha','352 SB18','All domains','DIN 911 / ISO 2936','OB',1,42,'Replace when worn','Daily use: socket cap screws, drives, relays, rail equipment.','https://www.wiha.com/fr-fr/outillage/cles-males/cles-6-pans'],
  ['t21','T','OUTILS','Individual Tool Bag – 18 compartments','Knipex','00 19 72 LE Tool Bag','All domains','–','OB',1,68,'Replace when worn','Holds VDE screwdrivers, pliers, voltage tester, multimeter, LOTO kit.','https://www.knipex.com/index.php?cl=details&artNum=001972LE'],
  ['t22','T','OUTILS','Heat Gun 2000W 50-600°C + 2 nozzles','Bosch','GHG 20-63 Professional','LV / DC – Sleeves & Cables','–','OB',1,95,'Replace if defective','Heat-shrink installation on lugs, cables, connectors.','https://www.bosch-professional.com/fr/fr/products/ghg-20-63-0601212200.html'],
  ...
  ['t26','T','OUTILS','Permanent Industrial Markers oil/heat resistant – pack 3','Edding','8300 Industrial Marker','All domains','–','OB',3,5.5,'Consumable','Black, red, white. Resistant to 120°C, solvents, oil.','https://www.edding.com/fr/produits/edding-8300-industrial-marker'],
  ['t27','T','OUTILS','Rechargeable Work Light 500 lm magnet IP54','Scangrip','Flex Wear 03.5122','All domains','IP54 – EN 60598','OB',1,55,'Annual (battery)','Position inside cabinet for local lighting. Hands-free operation.','https://www.scangrip.com/fr/produits/travail-general/flex-wear'],
  ['t28','T','OUTILS','Cordless Drill/Driver 18V + case + 2 batteries','Bosch','GSR 18V-55 Professional','All domains','–','OB',1,175,'Replace if defective','Fixing terminal blocks, cabinet covers, light cable trays.','https://www.bosch-professional.com/fr/fr/products/gsr-18v-55-0615A5002N.html'],
  ...
  ['t30','T','CABLE','Automatic Wire Stripper 0.2-6mm²','Jokari','30200 T-Stripper','LV / DC','–','OB',1,42,'Replace when worn','Auto-adjust by wire size. Daily use in 400V/24V cabinets.','https://www.jokari.de/products/t-stripper-vario'],
  ['t31','T','CABLE','Cable Jacket Knife – curved blade for armoured cables','Jokari','10250 Secura Coax','BT / HTA','–','OB',1,32,'Replace when worn','Safe jacket cutting without nicking conductors.','https://www.jokari.de/products/secura-coax'],
  ['t32','T','CABLE','Portable Cable Label Printer P-touch Bluetooth','Brother','PT-E310BT','All domains','–','RC',1,68,'Battery replacement','Oil/heat resistant tapes. Cable and terminal labelling.','https://www.brother.fr/products/labelling/pte310bt'],
  ...
  ['t34','T','LOTO','Personal LOTO Kit – individual pouch Brady','Brady','65674 Personal LOTO Kit','All domains','ISO 3864 / EN 1037','OB',1,58,'Annual (inspection)','Stainless steel padlock. Individual identification mandatory.','https://www.bradyid.eu/fr-fr/lockout-tagout/personal-lockout-kits/65674'],
  ['t35','T','LOTO','Lockout Padlock steel – 1 unique key','Master Lock','S410RED','All domains','ISO 3864','OB',2,16,'5 years or replacement','1 key = 1 worker. 2 padlocks: 1 in use + 1 spare.','https://www.masterlock.eu/fr/products/safety-lockout/safety-padlocks/S410RED'],
  ['t36','T','LOTO','Electrical Danger Lockout Tags – pack 25','Brady','65518','All domains','ISO 7010 – W012','OB',1,18,'Consumable','Rigid tag with eyelets. Shows danger warning + technician name.','https://www.bradyid.eu/fr-fr/lockout-tagout/lockout-tags/65518'],
  ...
  ['e08','E','OUTILS','Socket Set 1/2" + VDE metric box spanners 10-32mm','Facom','J.380-E2PB + SL.444','LV / MV – Heavy bolting','VDE partiel – IEC 60900','OB',1,195,'Replace when worn','Heavy bolting: busbars, transformers, MV switches.','https://www.facom.com/fr/tools/sockets/socket-sets'],
  ['e09','E','OUTILS','Cordless Impact Wrench 18V 440 Nm 1/2"','Bosch','GDS 18V-400 Professional','MV / HV – Heavy bolting','–','RC',1,265,'Replace if defective','Heavy bolt removal: MV busbars, transformers, SF6 equipment.','https://www.bosch-professional.com/fr/fr/products/gds-18v-400-06019A1300.html'],
  ['e10','E','OUTILS','Cordless Hammer Drill 18V + 2×4Ah batteries','Bosch','GSB 18V-55 Professional','All domains','–','RC',1,195,'Replace if defective','Heavy fixings, drilling cabinet metalwork, cable trays.','https://www.bosch-professional.com/fr/fr/products/gsb-18v-55-0615A5003N.html'],
  ...
  ['e22','E','MHTA','Three-phase Protection Relay Test Set','Omicron','CMC 353','MV / Protection','IEC 60255 – IEC 61850','OB',1,16500,'Annual (calibration)','Three-phase current/voltage injection. Tests differential, overcurrent, distance relays.','https://www.omicronenergy.com/fr/products/cmc-353'],
  ...
  ['e28','E','MBTDC','DC Network Analyser – voltage, power, energy','Metrel','MI2892 PowerQ4 Plus','DC Traction 750-1500V','IEC 61000-4-30','OB',1,2100,'Annual (calibration)','DC power quality analysis. Ripple, voltage drops, DC harmonics.','https://www.metrel.si/instruments/power-and-energy-analysers/MI2892'],
  ...
  ['e44','E','COLLECTIF','Portable Generator 3.5 kVA – 230V silent','Honda','EU30i','LV Auxiliaries','EN 12601','RC',1,1850,'Annual (oil change + service)','Backup power for diagnostic equipment in unpowered areas. 50-56 dB.','https://www.honda.fr/power/products/generators/eu30i.html'],
